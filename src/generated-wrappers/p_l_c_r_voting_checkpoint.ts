...
export class PLCRVotingCheckpointContract extends BaseContract {
  ...
  public static async deployAsync(
    ...
    const contractInstance = new PLCRVotingCheckpointContract(
  ...
  constructor(
    ...
    this._web3Wrapper.abiDecoder.addABI(PLCRVotingCheckpointContract.ABI());
