...
export type PolyTokenFaucetEventArgs = PolyTokenFaucetTransferEventArgs | PolyTokenFaucetApprovalEventArgs;
...
export class PolyTokenFaucetContract extends BaseContract {
  ...
  public static async deployAsync(
  ...
  ): Promise<PolyTokenFaucetContract> {
    ...
    const contractInstance = new PolyTokenFaucetContract(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    this._web3Wrapper.abiDecoder.addABI(PolyTokenFaucetContract.ABI(), '{contractName}');
