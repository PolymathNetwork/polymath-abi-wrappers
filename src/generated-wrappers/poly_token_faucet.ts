...
export class PolyTokenFaucetContract extends BaseContract {
    ...
    public getTokens = {
        async sendTransactionAsync(
            ...
            const self = this as any as PolyTokenFaucetContract;
            const encodedData = self._strictEncodeArguments('getTokens(uint256,address)', [_amount,
    _recipient
    ]);
    ...
    ,
        ...
        async estimateGasAsync(
            ...
            const self = this as any as PolyTokenFaucetContract;
            const encodedData = self._strictEncodeArguments('getTokens(uint256,address)',
            [_amount,
    _recipient
    ]);
            const contractDefaults = self._web3Wrapper.getContractDefaults();
    ...
    public static async deployAsync(
        ...
        const contractInstance = new PolyTokenFaucetContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
