...
export class DividendCheckpointContract extends BaseContract {
    ...
    public takeFee = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self.takeFee.estimateGasAsync.bind<DividendCheckpointContract, any, Promise<number>>(
                    self,
                    _amount
    ,
                    estimateGasFactor,
    ...
    public static async deployAsync(
        ...
        const contractInstance = new DividendCheckpointContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
