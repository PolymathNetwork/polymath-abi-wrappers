...
export class USDTieredSTOFactoryContract extends BaseContract {
  ...
  public static async deployAsync(
    ...
    const contractInstance = new USDTieredSTOFactoryContract(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    this._web3Wrapper.abiDecoder.addABI(USDTieredSTOFactoryContract.ABI());
