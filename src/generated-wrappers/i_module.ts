...
export class IModuleContract extends BaseContract {
  ...
  public static async deployAsync(
    ...
    const contractInstance = new IModuleContract(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('IModule', IModuleContract.ABI(), address, supportedProvider, txDefaults);
    this._defaultEstimateGasFactor = defaultEstimateGasFactor === undefined ? 1.1 : defaultEstimateGasFactor;
    this._web3Wrapper.abiDecoder.addABI(IModuleContract.ABI(), '{contractName}');
