...
export class ITransferManagerContract extends BaseContract {
  ...
  public executeTransfer = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.executeTransfer.estimateGasAsync.bind<ITransferManagerContract, any, Promise<number>>(
          self,
          _from,
          _to,
          _amount,
  ...
  public static async deployAsync(
    ...
    const contractInstance = new ITransferManagerContract(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('ITransferManager', ITransferManagerContract.ABI(), address, supportedProvider, txDefaults);
    this._defaultEstimateGasFactor = defaultEstimateGasFactor === undefined ? 1.1 : defaultEstimateGasFactor;
    this._web3Wrapper.abiDecoder.addABI(ITransferManagerContract.ABI(), '{contractName}');
