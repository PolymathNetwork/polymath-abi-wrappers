...
export class PolymathRegistryContract extends BaseContract {
  ...
  public static async deployAsync(
    ...
    const contractInstance = new PolymathRegistryContract(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('PolymathRegistry', PolymathRegistryContract.ABI(), address, supportedProvider, txDefaults);
    this._defaultEstimateGasFactor = defaultEstimateGasFactor === undefined ? 1.1 : defaultEstimateGasFactor;
    this._web3Wrapper.abiDecoder.addABI(PolymathRegistryContract.ABI(), '{contractName}');
