...
export type PolyTokenEventArgs = PolyTokenTransferEventArgs | PolyTokenApprovalEventArgs;
...
export class PolyTokenContract extends BaseContract {
  ...
  public static async deployAsync(
    ...
    const contractInstance = new PolyTokenContract(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    this._web3Wrapper.abiDecoder.addABI(PolyTokenContract.ABI(), '{contractName}');
