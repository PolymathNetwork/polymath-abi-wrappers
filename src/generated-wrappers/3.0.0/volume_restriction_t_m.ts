...
export type VolumeRestrictionTMEventArgs_3_0_0 =
...
export enum VolumeRestrictionTMEvents_3_0_0 {
...
export class VolumeRestrictionTMContract_3_0_0 extends BaseContract {
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as VolumeRestrictionTMContract_3_0_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<VolumeRestrictionTMContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<VolumeRestrictionTMContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<VolumeRestrictionTMContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<VolumeRestrictionTMContract_3_0_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public executeTransfer = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.executeTransfer.estimateGasAsync.bind<VolumeRestrictionTMContract_3_0_0, any, Promise<number>>(
          self,
          _from,
          index_1,
          _amount,
  ...
  public changeExemptWalletList = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeExemptWalletList.estimateGasAsync.bind<VolumeRestrictionTMContract_3_0_0, any, Promise<number>>(
          self,
          _wallet,
          _exempted,
          estimateGasFactor,
  ...
  public addIndividualRestriction = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addIndividualRestriction.estimateGasAsync.bind<VolumeRestrictionTMContract_3_0_0, any, Promise<number>>(
          self,
          _holder,
          _allowedTokens,
          _startTime,
  ...
  public addDefaultRestriction = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addDefaultRestriction.estimateGasAsync.bind<VolumeRestrictionTMContract_3_0_0, any, Promise<number>>(
          self,
          _allowedTokens,
          _startTime,
          _rollingPeriodInDays,
  ...
  public addDefaultDailyRestriction = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addDefaultDailyRestriction.estimateGasAsync.bind<VolumeRestrictionTMContract_3_0_0, any, Promise<number>>(
          self,
          _allowedTokens,
          _startTime,
          _endTime,
  ...
  public removeIndividualRestriction = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.removeIndividualRestriction.estimateGasAsync.bind<VolumeRestrictionTMContract_3_0_0, any, Promise<number>>(
          self,
          _holder,
          estimateGasFactor,
        ),
  ...
  public removeDefaultRestriction = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.removeDefaultRestriction.estimateGasAsync.bind<VolumeRestrictionTMContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public modifyIndividualRestriction = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.modifyIndividualRestriction.estimateGasAsync.bind<VolumeRestrictionTMContract_3_0_0, any, Promise<number>>(
          self,
          _holder,
          _allowedTokens,
          _startTime,
  ...
  public modifyDefaultRestriction = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.modifyDefaultRestriction.estimateGasAsync.bind<VolumeRestrictionTMContract_3_0_0, any, Promise<number>>(
          self,
          _allowedTokens,
          _startTime,
          _rollingPeriodInDays,
  ...
  public static async deployAsync(
    ...
    _polyAddress: string,
  ): Promise<VolumeRestrictionTMContract_3_0_0> {
    ...
    const contractInstance = new VolumeRestrictionTMContract_3_0_0(
  ...
  constructor(
    ...
    super('VolumeRestrictionTM', VolumeRestrictionTMContract_3_0_0.ABI(), address, supportedProvider, txDefaults);
...
export function isVolumeRestrictionTMContract_3_0_0(contract: any): contract is VolumeRestrictionTMContract_3_0_0 {
  return isEqual(VolumeRestrictionTMContract_3_0_0.ABI(), contract.abi);
}
