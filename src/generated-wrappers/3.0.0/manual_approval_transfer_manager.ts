...
export function isManualApprovalTransferManagerContract_3_0_0(
  contract: any,
): contract is ManualApprovalTransferManagerContract_3_0_0 {
  return isEqual(ManualApprovalTransferManagerContract_3_0_0.ABI(), contract.abi);
}
