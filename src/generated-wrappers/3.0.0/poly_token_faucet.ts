...
export function isPolyTokenFaucetContract_3_0_0(contract: any): contract is PolyTokenFaucetContract_3_0_0 {
  return isEqual(PolyTokenFaucetContract_3_0_0.ABI(), contract.abi);
}
