...
export enum ERC20DetailedEvents_3_0_0 {
  Transfer = 'Transfer',
  Approval = 'Approval',
}

export interface ERC20DetailedTransferEventArgs_3_0_0 extends DecodedLogArgs {
  from: string;
  to: string;
  value: BigNumber;
}
export interface ERC20DetailedApprovalEventArgs_3_0_0 extends DecodedLogArgs {
  owner: string;
  spender: string;
  value: BigNumber;
}
...
export class ERC20DetailedContract_3_0_0 extends BaseContract {
  ...
  public approve = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as ERC20DetailedContract_3_0_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.approve.estimateGasAsync.bind<ERC20DetailedContract_3_0_0, any, Promise<number>>(
          self,
          spender,
          value,
          estimateGasFactor,
  ...
  public transferFrom = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.transferFrom.estimateGasAsync.bind<ERC20DetailedContract_3_0_0, any, Promise<number>>(
          self,
          from,
          to,
          value,
  ...
  public transfer = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.transfer.estimateGasAsync.bind<ERC20DetailedContract_3_0_0, any, Promise<number>>(
          self,
          to,
          value,
          estimateGasFactor,
  ...
  public static async deployAsync(
  ...
  ): Promise<ERC20DetailedContract_3_0_0> {
    ...
    const contractInstance = new ERC20DetailedContract_3_0_0(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('ERC20Detailed', ERC20DetailedContract_3_0_0.ABI(), address, supportedProvider, txDefaults);
...
export function isERC20DetailedContract_3_0_0(contract: any): contract is ERC20DetailedContract_3_0_0 {
  return isEqual(ERC20DetailedContract_3_0_0.ABI(), contract.abi);
}
