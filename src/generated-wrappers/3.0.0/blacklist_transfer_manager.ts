...
export enum BlacklistTransferManagerEvents_3_0_0 {
...
export class BlacklistTransferManagerContract_3_0_0 extends BaseContract {
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as BlacklistTransferManagerContract_3_0_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<BlacklistTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<BlacklistTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<BlacklistTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<BlacklistTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public executeTransfer = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.executeTransfer.estimateGasAsync.bind<BlacklistTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _from,
          index_1,
          index_2,
  ...
  public addBlacklistType = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addBlacklistType.estimateGasAsync.bind<BlacklistTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _startTime,
          _endTime,
          _blacklistName,
  ...
  public addBlacklistTypeMulti = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addBlacklistTypeMulti.estimateGasAsync.bind<BlacklistTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _startTimes,
          _endTimes,
          _blacklistNames,
  ...
  public modifyBlacklistType = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.modifyBlacklistType.estimateGasAsync.bind<BlacklistTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _startTime,
          _endTime,
          _blacklistName,
  ...
  public deleteBlacklistType = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.deleteBlacklistType.estimateGasAsync.bind<BlacklistTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _blacklistName,
          estimateGasFactor,
        ),
  ...
  public addInvestorToBlacklist = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addInvestorToBlacklist.estimateGasAsync.bind<BlacklistTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _investor,
          _blacklistName,
          estimateGasFactor,
  ...
  public static async deployAsync(
    ...
    _polyAddress: string,
  ): Promise<BlacklistTransferManagerContract_3_0_0> {
    ...
    const contractInstance = new BlacklistTransferManagerContract_3_0_0(
...
export function isBlacklistTransferManagerContract_3_0_0(
  contract: any,
): contract is BlacklistTransferManagerContract_3_0_0 {
  return isEqual(BlacklistTransferManagerContract_3_0_0.ABI(), contract.abi);
}
