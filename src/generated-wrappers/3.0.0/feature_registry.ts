...
export enum FeatureRegistryEvents_3_0_0 {
  OwnershipTransferred = 'OwnershipTransferred',
  ChangeFeatureStatus = 'ChangeFeatureStatus',
}

export interface FeatureRegistryOwnershipTransferredEventArgs_3_0_0 extends DecodedLogArgs {
  previousOwner: string;
  newOwner: string;
}
export interface FeatureRegistryChangeFeatureStatusEventArgs_3_0_0 extends DecodedLogArgs {
  _nameKey: string;
  _newStatus: boolean;
}
...
export class FeatureRegistryContract_3_0_0 extends BaseContract {
  ...
  public renounceOwnership = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as FeatureRegistryContract_3_0_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.renounceOwnership.estimateGasAsync.bind<FeatureRegistryContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<FeatureRegistryContract_3_0_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public featureStatus = {
    ...
    getABIEncodedTransactionData(index_0: string): string {
      assert.isString('index_0', index_0);
      const self = (this as any) as FeatureRegistryContract_3_0_0;
      const abiEncodedTransactionData = self._strictEncodeArguments('featureStatus(bytes32)', [index_0]);
      return abiEncodedTransactionData;
    },
  };
  public transferOwnership = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.transferOwnership.estimateGasAsync.bind<FeatureRegistryContract_3_0_0, any, Promise<number>>(
          self,
          newOwner,
          estimateGasFactor,
        ),
  ...
  public getFeatureStatus = {
    async callAsync(_nameKey: string, callData: Partial<CallData> = {}, defaultBlock?: BlockParam): Promise<boolean> {
    ...
    getABIEncodedTransactionData(_nameKey: string): string {
      assert.isString('_nameKey', _nameKey);
      const self = (this as any) as FeatureRegistryContract_3_0_0;
      const abiEncodedTransactionData = self._strictEncodeArguments('getFeatureStatus(string)', [_nameKey]);
      return abiEncodedTransactionData;
    },
  };
  public setFeatureStatus = {
    async sendTransactionAsync(
      ...
      assert.isString('_nameKey', _nameKey);
      assert.isBoolean('_newStatus', _newStatus);
      const self = (this as any) as FeatureRegistryContract_3_0_0;
      const encodedData = self._strictEncodeArguments('setFeatureStatus(string,bool)', [_nameKey, _newStatus]);
      const contractDefaults = self._web3Wrapper.getContractDefaults();
      const defaultFromAddress = (await self._web3Wrapper.getAvailableAddressesAsync())[0];
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        {
        ...
        self.setFeatureStatus.estimateGasAsync.bind<FeatureRegistryContract_3_0_0, any, Promise<number>>(
          self,
          _nameKey,
          _newStatus,
          estimateGasFactor,
  ...
  public static async deployAsync(
  ...
  ): Promise<FeatureRegistryContract_3_0_0> {
    ...
    const contractInstance = new FeatureRegistryContract_3_0_0(
  ...
  constructor(
    ...
    super('FeatureRegistry', FeatureRegistryContract_3_0_0.ABI(), address, supportedProvider, txDefaults);
...
export function isFeatureRegistryContract_3_0_0(contract: any): contract is FeatureRegistryContract_3_0_0 {
  return isEqual(FeatureRegistryContract_3_0_0.ABI(), contract.abi);
}
