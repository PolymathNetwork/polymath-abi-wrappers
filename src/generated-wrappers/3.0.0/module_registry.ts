...
export type ModuleRegistryEventArgs_3_0_0 =
...
export enum ModuleRegistryEvents_3_0_0 {
  Pause = 'Pause',
  Unpause = 'Unpause',
...
export interface ModuleRegistryPauseEventArgs_3_0_0 extends DecodedLogArgs {
  account: string;
}
export interface ModuleRegistryUnpauseEventArgs_3_0_0 extends DecodedLogArgs {
  account: string;
}
export interface ModuleRegistryModuleUsedEventArgs_3_0_0 extends DecodedLogArgs {
  _moduleFactory: string;
  _securityToken: string;
}
export interface ModuleRegistryModuleRegisteredEventArgs_3_0_0 extends DecodedLogArgs {
  _moduleFactory: string;
  _owner: string;
}
export interface ModuleRegistryModuleVerifiedEventArgs_3_0_0 extends DecodedLogArgs {
  _moduleFactory: string;
}
export interface ModuleRegistryModuleUnverifiedEventArgs_3_0_0 extends DecodedLogArgs {
  _moduleFactory: string;
}
export interface ModuleRegistryModuleRemovedEventArgs_3_0_0 extends DecodedLogArgs {
  _moduleFactory: string;
  _decisionMaker: string;
}
export interface ModuleRegistryOwnershipTransferredEventArgs_3_0_0 extends DecodedLogArgs {
...
export class ModuleRegistryContract_3_0_0 extends BaseContract {
  ...
  public getBytes32Value = {
    async callAsync(_variable: string, callData: Partial<CallData> = {}, defaultBlock?: BlockParam): Promise<string> {
      ...
      const self = (this as any) as ModuleRegistryContract_3_0_0;
  ...
  public initialize = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.initialize.estimateGasAsync.bind<ModuleRegistryContract_3_0_0, any, Promise<number>>(
          self,
          _polymathRegistry,
          _owner,
          estimateGasFactor,
  ...
  public useModule2 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.useModule2.estimateGasAsync.bind<ModuleRegistryContract_3_0_0, any, Promise<number>>(
          self,
          _moduleFactory,
          _isUpgrade,
          estimateGasFactor,
  ...
  public useModule1 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.useModule1.estimateGasAsync.bind<ModuleRegistryContract_3_0_0, any, Promise<number>>(
          self,
          _moduleFactory,
          estimateGasFactor,
        ),
  ...
  public registerModule = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.registerModule.estimateGasAsync.bind<ModuleRegistryContract_3_0_0, any, Promise<number>>(
          self,
          _moduleFactory,
          estimateGasFactor,
        ),
  ...
  public removeModule = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.removeModule.estimateGasAsync.bind<ModuleRegistryContract_3_0_0, any, Promise<number>>(
          self,
          _moduleFactory,
          estimateGasFactor,
        ),
  ...
  public verifyModule = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.verifyModule.estimateGasAsync.bind<ModuleRegistryContract_3_0_0, any, Promise<number>>(
          self,
          _moduleFactory,
          estimateGasFactor,
        ),
  ...
  public unverifyModule = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unverifyModule.estimateGasAsync.bind<ModuleRegistryContract_3_0_0, any, Promise<number>>(
          self,
          _moduleFactory,
          estimateGasFactor,
        ),
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<ModuleRegistryContract_3_0_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<ModuleRegistryContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<ModuleRegistryContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public updateFromRegistry = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.updateFromRegistry.estimateGasAsync.bind<ModuleRegistryContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public transferOwnership = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.transferOwnership.estimateGasAsync.bind<ModuleRegistryContract_3_0_0, any, Promise<number>>(
          self,
          _newOwner,
          estimateGasFactor,
        ),
  ...
  public static async deployAsync(
  ...
  ): Promise<ModuleRegistryContract_3_0_0> {
    ...
    const contractInstance = new ModuleRegistryContract_3_0_0(
  ...
  constructor(
    ...
    super('ModuleRegistry', ModuleRegistryContract_3_0_0.ABI(), address, supportedProvider, txDefaults);
...
export function isModuleRegistryContract_3_0_0(contract: any): contract is ModuleRegistryContract_3_0_0 {
  return isEqual(ModuleRegistryContract_3_0_0.ABI(), contract.abi);
}
