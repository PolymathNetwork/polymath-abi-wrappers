...
export class IModuleContract_3_0_0 extends BaseContract {
  ...
  public getInitFunction = {
    async callAsync(callData: Partial<CallData> = {}, defaultBlock?: BlockParam): Promise<string> {
      ...
      const self = (this as any) as IModuleContract_3_0_0;
  ...
  public static async deployAsync(
    ...
    const contractInstance = new IModuleContract_3_0_0(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('IModule', IModuleContract_3_0_0.ABI(), address, supportedProvider, txDefaults);
...
export function isIModuleContract_3_0_0(contract: any): contract is IModuleContract_3_0_0 {
  return isEqual(IModuleContract_3_0_0.ABI(), contract.abi);
}
