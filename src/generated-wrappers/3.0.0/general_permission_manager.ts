...
export enum GeneralPermissionManagerEvents_3_0_0 {
...
export interface GeneralPermissionManagerChangePermissionEventArgs_3_0_0 extends DecodedLogArgs {
  _delegate: string;
  _module: string;
  _perm: string;
  _valid: boolean;
}
export interface GeneralPermissionManagerAddDelegateEventArgs_3_0_0 extends DecodedLogArgs {
  _delegate: string;
  _details: string;
}
export interface GeneralPermissionManagerPauseEventArgs_3_0_0 extends DecodedLogArgs {
  account: string;
}
export interface GeneralPermissionManagerUnpauseEventArgs_3_0_0 extends DecodedLogArgs {
  account: string;
}
...
export class GeneralPermissionManagerContract_3_0_0 extends BaseContract {
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as GeneralPermissionManagerContract_3_0_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<GeneralPermissionManagerContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<GeneralPermissionManagerContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<GeneralPermissionManagerContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<GeneralPermissionManagerContract_3_0_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public addDelegate = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addDelegate.estimateGasAsync.bind<GeneralPermissionManagerContract_3_0_0, any, Promise<number>>(
          self,
          _delegate,
          _details,
          estimateGasFactor,
  ...
  public deleteDelegate = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.deleteDelegate.estimateGasAsync.bind<GeneralPermissionManagerContract_3_0_0, any, Promise<number>>(
          self,
          _delegate,
          estimateGasFactor,
        ),
  ...
  public changePermission = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changePermission.estimateGasAsync.bind<GeneralPermissionManagerContract_3_0_0, any, Promise<number>>(
          self,
          _delegate,
          _module,
          _perm,
  ...
  public changePermissionMulti = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changePermissionMulti.estimateGasAsync.bind<GeneralPermissionManagerContract_3_0_0, any, Promise<number>>(
          self,
          _delegate,
          _modules,
          _perms,
  ...
  public static async deployAsync(
    ...
    _polyToken: string,
  ): Promise<GeneralPermissionManagerContract_3_0_0> {
    ...
    const contractInstance = new GeneralPermissionManagerContract_3_0_0(
...
export function isGeneralPermissionManagerContract_3_0_0(
  contract: any,
): contract is GeneralPermissionManagerContract_3_0_0 {
  return isEqual(GeneralPermissionManagerContract_3_0_0.ABI(), contract.abi);
}
