...
export enum CappedSTOEvents_3_0_0 {
...
export class CappedSTOContract_3_0_0 extends BaseContract {
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as CappedSTOContract_3_0_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<CappedSTOContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<CappedSTOContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<CappedSTOContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<CappedSTOContract_3_0_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public configure = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.configure.estimateGasAsync.bind<CappedSTOContract_3_0_0, any, Promise<number>>(
          self,
          _startTime,
          _endTime,
          _cap,
    ...
    getABIEncodedTransactionData(
      ...
      const abiEncodedTransactionData = self._strictEncodeArguments(
        ...
        [_startTime, _endTime, _cap, _rate, _fundRaiseTypes, _fundsReceiver],
      );
      return abiEncodedTransactionData;
    },
  };
  ...
  public changeAllowBeneficialInvestments = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeAllowBeneficialInvestments.estimateGasAsync.bind<CappedSTOContract_3_0_0, any, Promise<number>>(
          self,
          _allowBeneficialInvestments,
          estimateGasFactor,
        ),
  ...
  public buyTokens = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.buyTokens.estimateGasAsync.bind<CappedSTOContract_3_0_0, any, Promise<number>>(
          self,
          _beneficiary,
          estimateGasFactor,
        ),
  ...
  public buyTokensWithPoly = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.buyTokensWithPoly.estimateGasAsync.bind<CappedSTOContract_3_0_0, any, Promise<number>>(
          self,
          _investedPOLY,
          estimateGasFactor,
        ),
  ...
  public static async deployAsync(
    ...
    _polyToken: string,
  ): Promise<CappedSTOContract_3_0_0> {
    ...
    const contractInstance = new CappedSTOContract_3_0_0(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('CappedSTO', CappedSTOContract_3_0_0.ABI(), address, supportedProvider, txDefaults);
...
export function isCappedSTOContract_3_0_0(contract: any): contract is CappedSTOContract_3_0_0 {
  return isEqual(CappedSTOContract_3_0_0.ABI(), contract.abi);
}
