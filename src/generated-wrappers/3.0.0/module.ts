...
export enum ModuleEvents_3_0_0 {
  Pause = 'Pause',
  Unpause = 'Unpause',
}

export interface ModulePauseEventArgs_3_0_0 extends DecodedLogArgs {
  account: string;
}
export interface ModuleUnpauseEventArgs_3_0_0 extends DecodedLogArgs {
  account: string;
}
...
export class ModuleContract_3_0_0 extends BaseContract {
  ...
  public getInitFunction = {
    async callAsync(callData: Partial<CallData> = {}, defaultBlock?: BlockParam): Promise<string> {
      ...
      const self = (this as any) as ModuleContract_3_0_0;
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<ModuleContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<ModuleContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<ModuleContract_3_0_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<ModuleContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public static async deployAsync(
    ...
    const contractInstance = new ModuleContract_3_0_0(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('Module', ModuleContract_3_0_0.ABI(), address, supportedProvider, txDefaults);
...
export function isModuleContract_3_0_0(contract: any): contract is ModuleContract_3_0_0 {
  return isEqual(ModuleContract_3_0_0.ABI(), contract.abi);
}
