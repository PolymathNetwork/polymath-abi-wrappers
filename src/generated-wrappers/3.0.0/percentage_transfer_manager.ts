...
export type PercentageTransferManagerEventArgs_3_0_0 =
...
export enum PercentageTransferManagerEvents_3_0_0 {
...
export interface PercentageTransferManagerModifyHolderPercentageEventArgs_3_0_0 extends DecodedLogArgs {
  _oldHolderPercentage: BigNumber;
  _newHolderPercentage: BigNumber;
}
export interface PercentageTransferManagerModifyWhitelistEventArgs_3_0_0 extends DecodedLogArgs {
  _investor: string;
  _addedBy: string;
  _valid: boolean;
}
export interface PercentageTransferManagerSetAllowPrimaryIssuanceEventArgs_3_0_0 extends DecodedLogArgs {
  _allowPrimaryIssuance: boolean;
}
export interface PercentageTransferManagerPauseEventArgs_3_0_0 extends DecodedLogArgs {
  account: string;
}
export interface PercentageTransferManagerUnpauseEventArgs_3_0_0 extends DecodedLogArgs {
  account: string;
}
...
export class PercentageTransferManagerContract_3_0_0 extends BaseContract {
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as PercentageTransferManagerContract_3_0_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<PercentageTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<PercentageTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<PercentageTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<PercentageTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public executeTransfer = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.executeTransfer.estimateGasAsync.bind<PercentageTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _from,
          _to,
          _amount,
  ...
  public configure = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.configure.estimateGasAsync.bind<PercentageTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _maxHolderPercentage,
          _allowPrimaryIssuance,
          estimateGasFactor,
  ...
  public modifyWhitelist = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.modifyWhitelist.estimateGasAsync.bind<PercentageTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _investor,
          _valid,
          estimateGasFactor,
  ...
  public modifyWhitelistMulti = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.modifyWhitelistMulti.estimateGasAsync.bind<PercentageTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _investors,
          _valids,
          estimateGasFactor,
  ...
  public static async deployAsync(
    ...
    _polyToken: string,
  ): Promise<PercentageTransferManagerContract_3_0_0> {
    ...
    const contractInstance = new PercentageTransferManagerContract_3_0_0(
...
export function isPercentageTransferManagerContract_3_0_0(
  contract: any,
): contract is PercentageTransferManagerContract_3_0_0 {
  return isEqual(PercentageTransferManagerContract_3_0_0.ABI(), contract.abi);
}
