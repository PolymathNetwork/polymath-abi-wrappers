...
export enum CountTransferManagerEvents_3_0_0 {
  ModifyHolderCount = 'ModifyHolderCount',
  Pause = 'Pause',
  Unpause = 'Unpause',
}

export interface CountTransferManagerModifyHolderCountEventArgs_3_0_0 extends DecodedLogArgs {
  _oldHolderCount: BigNumber;
  _newHolderCount: BigNumber;
}
export interface CountTransferManagerPauseEventArgs_3_0_0 extends DecodedLogArgs {
  account: string;
}
export interface CountTransferManagerUnpauseEventArgs_3_0_0 extends DecodedLogArgs {
  account: string;
}
...
export class CountTransferManagerContract_3_0_0 extends BaseContract {
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as CountTransferManagerContract_3_0_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<CountTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<CountTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<CountTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<CountTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public executeTransfer = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.executeTransfer.estimateGasAsync.bind<CountTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _from,
          _to,
          _amount,
  ...
  public configure = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.configure.estimateGasAsync.bind<CountTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _maxHolderCount,
          estimateGasFactor,
        ),
  ...
  public changeHolderCount = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeHolderCount.estimateGasAsync.bind<CountTransferManagerContract_3_0_0, any, Promise<number>>(
          self,
          _maxHolderCount,
          estimateGasFactor,
        ),
  ...
  public static async deployAsync(
    ...
    _polyToken: string,
  ): Promise<CountTransferManagerContract_3_0_0> {
    ...
    const contractInstance = new CountTransferManagerContract_3_0_0(
  ...
  constructor(
    ...
    super('CountTransferManager', CountTransferManagerContract_3_0_0.ABI(), address, supportedProvider, txDefaults);
...
export function isCountTransferManagerContract_3_0_0(contract: any): contract is CountTransferManagerContract_3_0_0 {
  return isEqual(CountTransferManagerContract_3_0_0.ABI(), contract.abi);
}
