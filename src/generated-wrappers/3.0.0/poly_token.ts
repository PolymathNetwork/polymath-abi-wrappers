...
export type PolyTokenEventArgs_3_0_0 = PolyTokenTransferEventArgs_3_0_0 | PolyTokenApprovalEventArgs_3_0_0;

export enum PolyTokenEvents_3_0_0 {
  Transfer = 'Transfer',
  Approval = 'Approval',
}

export interface PolyTokenTransferEventArgs_3_0_0 extends DecodedLogArgs {
  from: string;
  to: string;
  value: BigNumber;
}
export interface PolyTokenApprovalEventArgs_3_0_0 extends DecodedLogArgs {
  owner: string;
  spender: string;
  value: BigNumber;
}
...
export class PolyTokenContract_3_0_0 extends BaseContract {
  ...
  public name = {
    async callAsync(callData: Partial<CallData> = {}, defaultBlock?: BlockParam): Promise<string> {
      ...
      const self = (this as any) as PolyTokenContract_3_0_0;
  ...
  public transfer = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.transfer.estimateGasAsync.bind<PolyTokenContract_3_0_0, any, Promise<number>>(
          self,
          _to,
          _value,
          estimateGasFactor,
  ...
  public transferFrom = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.transferFrom.estimateGasAsync.bind<PolyTokenContract_3_0_0, any, Promise<number>>(
          self,
          _from,
          _to,
          _value,
  ...
  public approve = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.approve.estimateGasAsync.bind<PolyTokenContract_3_0_0, any, Promise<number>>(
          self,
          _spender,
          _value,
          estimateGasFactor,
  ...
  public increaseApproval = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.increaseApproval.estimateGasAsync.bind<PolyTokenContract_3_0_0, any, Promise<number>>(
          self,
          _spender,
          _addedValue,
          estimateGasFactor,
  ...
  public decreaseApproval = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.decreaseApproval.estimateGasAsync.bind<PolyTokenContract_3_0_0, any, Promise<number>>(
          self,
          _spender,
          _subtractedValue,
          estimateGasFactor,
  ...
  public static async deployAsync(
  ...
  ): Promise<PolyTokenContract_3_0_0> {
    ...
    const contractInstance = new PolyTokenContract_3_0_0(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('PolyToken', PolyTokenContract_3_0_0.ABI(), address, supportedProvider, txDefaults);
...
export function isPolyTokenContract_3_0_0(contract: any): contract is PolyTokenContract_3_0_0 {
  return isEqual(PolyTokenContract_3_0_0.ABI(), contract.abi);
}
