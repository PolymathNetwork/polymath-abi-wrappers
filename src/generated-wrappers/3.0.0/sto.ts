...
export type STOEventArgs_3_0_0 =
  | STOPauseEventArgs_3_0_0
  | STOUnpauseEventArgs_3_0_0
  | STOSetFundRaiseTypesEventArgs_3_0_0;

export enum STOEvents_3_0_0 {
  Pause = 'Pause',
  Unpause = 'Unpause',
  SetFundRaiseTypes = 'SetFundRaiseTypes',
}

export interface STOPauseEventArgs_3_0_0 extends DecodedLogArgs {
  account: string;
}
export interface STOUnpauseEventArgs_3_0_0 extends DecodedLogArgs {
  account: string;
}
export interface STOSetFundRaiseTypesEventArgs_3_0_0 extends DecodedLogArgs {
...
export class STOContract_3_0_0 extends BaseContract {
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as STOContract_3_0_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<STOContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<STOContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<STOContract_3_0_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<STOContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public static async deployAsync(
    ...
    const contractInstance = new STOContract_3_0_0(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('STO', STOContract_3_0_0.ABI(), address, supportedProvider, txDefaults);
