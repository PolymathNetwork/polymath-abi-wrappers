...
export class ISTOContract_3_0_0 extends BaseContract {
  ...
  public getTokensSold = {
    async callAsync(callData: Partial<CallData> = {}, defaultBlock?: BlockParam): Promise<BigNumber> {
      ...
      const self = (this as any) as ISTOContract_3_0_0;
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<ISTOContract_3_0_0, any, Promise<number>>(
          self,
  ...
  public static async deployAsync(
    ...
    const contractInstance = new ISTOContract_3_0_0(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('ISTO', ISTOContract_3_0_0.ABI(), address, supportedProvider, txDefaults);
...
export function isISTOContract_3_0_0(contract: any): contract is ISTOContract_3_0_0 {
  return isEqual(ISTOContract_3_0_0.ABI(), contract.abi);
}
