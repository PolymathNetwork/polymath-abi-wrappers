...
export type STOEventArgs = STOPauseEventArgs | STOUnpauseEventArgs | STOSetFundRaiseTypesEventArgs;
...
export class STOContract extends BaseContract {
  ...
  constructor(
    ...
    this._web3Wrapper.abiDecoder.addABI(STOContract.ABI(), '{contractName}');
