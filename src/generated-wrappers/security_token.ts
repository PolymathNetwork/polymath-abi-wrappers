...
export class SecurityTokenContract extends BaseContract {
  ...
  public static async deployAsync(
    ...
    const contractInstance = new SecurityTokenContract(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('SecurityToken', SecurityTokenContract.ABI(), address, supportedProvider, txDefaults);
    this._defaultEstimateGasFactor = defaultEstimateGasFactor === undefined ? 1.1 : defaultEstimateGasFactor;
    this._web3Wrapper.abiDecoder.addABI(SecurityTokenContract.ABI(), '{contractName}');
