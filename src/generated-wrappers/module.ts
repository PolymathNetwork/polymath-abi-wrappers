    ...
    public takeFee = {
        async sendTransactionAsync(
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self.takeFee.estimateGasAsync.bind<ModuleContract, any, Promise<number>>(
                    self,
                    _amount
    ,
                    estimateGasFactor,
...
_polyAddress
        ...
        const contractInstance = new ModuleContract(abi, txReceipt.contractAddress as string, provider, txDefaults);
