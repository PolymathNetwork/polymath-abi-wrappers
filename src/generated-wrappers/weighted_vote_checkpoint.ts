...
export class WeightedVoteCheckpointContract extends BaseContract {
    ...
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeDefaultExemptedVotersListMulti.estimateGasAsync.bind<
          WeightedVoteCheckpointContract,
          any,
          Promise<number>
  ...
  public static async deployAsync(
    ...
    const contractInstance = new WeightedVoteCheckpointContract(
  ...
  constructor(
    ...
    this._web3Wrapper.abiDecoder.addABI(WeightedVoteCheckpointContract.ABI());
