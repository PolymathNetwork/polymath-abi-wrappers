...
export class ISTOContract extends BaseContract {
  ...
  public static async deployAsync(
    ...
    const contractInstance = new ISTOContract(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('ISTO', ISTOContract.ABI(), address, supportedProvider, txDefaults);
    this._defaultEstimateGasFactor = defaultEstimateGasFactor === undefined ? 1.1 : defaultEstimateGasFactor;
    this._web3Wrapper.abiDecoder.addABI(ISTOContract.ABI(), '{contractName}');
