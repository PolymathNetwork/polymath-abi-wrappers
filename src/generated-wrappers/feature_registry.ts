...
export class FeatureRegistryContract extends BaseContract {
  ...
  public static async deployAsync(
    ...
    const contractInstance = new FeatureRegistryContract(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    this._web3Wrapper.abiDecoder.addABI(FeatureRegistryContract.ABI(), '{contractName}');
