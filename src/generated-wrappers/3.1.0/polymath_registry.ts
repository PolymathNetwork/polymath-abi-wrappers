...
export type PolymathRegistryEventArgs_3_1_0 =
  | PolymathRegistryChangeAddressEventArgs_3_1_0
  | PolymathRegistryOwnershipTransferredEventArgs_3_1_0;

export enum PolymathRegistryEvents_3_1_0 {
  ChangeAddress = 'ChangeAddress',
  OwnershipTransferred = 'OwnershipTransferred',
}

export interface PolymathRegistryChangeAddressEventArgs_3_1_0 extends DecodedLogArgs {
  _nameKey: string;
  _oldAddress: string;
  _newAddress: string;
}
export interface PolymathRegistryOwnershipTransferredEventArgs_3_1_0 extends DecodedLogArgs {
...
export class PolymathRegistryContract_3_1_0 extends BaseContract {
  ...
  public storedAddresses = {
    async callAsync(index_0: string, callData: Partial<CallData> = {}, defaultBlock?: BlockParam): Promise<string> {
      ...
      const self = (this as any) as PolymathRegistryContract_3_1_0;
  ...
  public renounceOwnership = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.renounceOwnership.estimateGasAsync.bind<PolymathRegistryContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<PolymathRegistryContract_3_1_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public transferOwnership = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.transferOwnership.estimateGasAsync.bind<PolymathRegistryContract_3_1_0, any, Promise<number>>(
          self,
          newOwner,
          estimateGasFactor,
        ),
  ...
  public changeAddress = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeAddress.estimateGasAsync.bind<PolymathRegistryContract_3_1_0, any, Promise<number>>(
          self,
          _nameKey,
          _newAddress,
          estimateGasFactor,
  ...
  public static async deployAsync(
  ...
  ): Promise<PolymathRegistryContract_3_1_0> {
    ...
    const contractInstance = new PolymathRegistryContract_3_1_0(
  ...
  constructor(
    ...
    super('PolymathRegistry', PolymathRegistryContract_3_1_0.ABI(), address, supportedProvider, txDefaults);
...
export function isPolymathRegistryContract_3_1_0(contract: any): contract is PolymathRegistryContract_3_1_0 {
  return isEqual(PolymathRegistryContract_3_1_0.ABI(), contract.abi);
}
