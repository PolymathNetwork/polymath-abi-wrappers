...
export function isGeneralPermissionManagerContract_3_1_0(
  contract: any,
): contract is GeneralPermissionManagerContract_3_1_0 {
  return isEqual(GeneralPermissionManagerContract_3_1_0.ABI(), contract.abi);
}
