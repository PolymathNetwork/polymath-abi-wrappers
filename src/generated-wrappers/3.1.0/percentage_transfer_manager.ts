...
export type PercentageTransferManagerEventArgs_3_1_0 =
  | PercentageTransferManagerModifyHolderPercentageEventArgs_3_1_0
  | PercentageTransferManagerModifyWhitelistEventArgs_3_1_0
  | PercentageTransferManagerSetAllowPrimaryIssuanceEventArgs_3_1_0
  | PercentageTransferManagerPauseEventArgs_3_1_0
  | PercentageTransferManagerUnpauseEventArgs_3_1_0;

export enum PercentageTransferManagerEvents_3_1_0 {
...
export interface PercentageTransferManagerModifyHolderPercentageEventArgs_3_1_0 extends DecodedLogArgs {
  _oldHolderPercentage: BigNumber;
  _newHolderPercentage: BigNumber;
}
export interface PercentageTransferManagerModifyWhitelistEventArgs_3_1_0 extends DecodedLogArgs {
  _investor: string;
  _addedBy: string;
  _valid: boolean;
}
export interface PercentageTransferManagerSetAllowPrimaryIssuanceEventArgs_3_1_0 extends DecodedLogArgs {
  _allowPrimaryIssuance: boolean;
}
export interface PercentageTransferManagerPauseEventArgs_3_1_0 extends DecodedLogArgs {
  account: string;
}
export interface PercentageTransferManagerUnpauseEventArgs_3_1_0 extends DecodedLogArgs {
  account: string;
}
...
export class PercentageTransferManagerContract_3_1_0 extends BaseContract {
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as PercentageTransferManagerContract_3_1_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<PercentageTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<PercentageTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<PercentageTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<PercentageTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public executeTransfer = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.executeTransfer.estimateGasAsync.bind<PercentageTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _from,
          _to,
          _amount,
  ...
  public configure = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.configure.estimateGasAsync.bind<PercentageTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _maxHolderPercentage,
          _allowPrimaryIssuance,
          estimateGasFactor,
  ...
  public changeHolderPercentage = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeHolderPercentage.estimateGasAsync.bind<
          PercentageTransferManagerContract_3_1_0,
          any,
          Promise<number>
        >(self, _maxHolderPercentage, estimateGasFactor),
      );
      if (txDataWithDefaults.from !== undefined) {
        txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
      }
  ...
  public modifyWhitelist = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.modifyWhitelist.estimateGasAsync.bind<PercentageTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _investor,
          _valid,
          estimateGasFactor,
  ...
  public modifyWhitelistMulti = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.modifyWhitelistMulti.estimateGasAsync.bind<PercentageTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _investors,
          _valids,
          estimateGasFactor,
  ...
  public setAllowPrimaryIssuance = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.setAllowPrimaryIssuance.estimateGasAsync.bind<
          PercentageTransferManagerContract_3_1_0,
          any,
          Promise<number>
        >(self, _allowPrimaryIssuance, estimateGasFactor),
      );
      if (txDataWithDefaults.from !== undefined) {
        txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
      }
  ...
  public static async deployAsync(
    ...
    _polyToken: string,
  ): Promise<PercentageTransferManagerContract_3_1_0> {
    ...
    const contractInstance = new PercentageTransferManagerContract_3_1_0(
  ...
  constructor(
    ...
    super(
      ...
      PercentageTransferManagerContract_3_1_0.ABI(),
      address,
      supportedProvider,
      txDefaults,
    );
...
export function isPercentageTransferManagerContract_3_1_0(
  contract: any,
): contract is PercentageTransferManagerContract_3_1_0 {
  return isEqual(PercentageTransferManagerContract_3_1_0.ABI(), contract.abi);
}
