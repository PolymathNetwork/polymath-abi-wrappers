...
export type PolyTokenFaucetEventArgs_3_1_0 =
  | PolyTokenFaucetTransferEventArgs_3_1_0
  | PolyTokenFaucetApprovalEventArgs_3_1_0;

export enum PolyTokenFaucetEvents_3_1_0 {
  Transfer = 'Transfer',
  Approval = 'Approval',
}

export interface PolyTokenFaucetTransferEventArgs_3_1_0 extends DecodedLogArgs {
  from: string;
  to: string;
  value: BigNumber;
}
export interface PolyTokenFaucetApprovalEventArgs_3_1_0 extends DecodedLogArgs {
  owner: string;
  spender: string;
  value: BigNumber;
}
...
export class PolyTokenFaucetContract_3_1_0 extends BaseContract {
  ...
  public name = {
    async callAsync(callData: Partial<CallData> = {}, defaultBlock?: BlockParam): Promise<string> {
      ...
      const self = (this as any) as PolyTokenFaucetContract_3_1_0;
  ...
  public getTokens = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.getTokens.estimateGasAsync.bind<PolyTokenFaucetContract_3_1_0, any, Promise<number>>(
          self,
          _amount,
          _recipient,
          estimateGasFactor,
  ...
  public transfer = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.transfer.estimateGasAsync.bind<PolyTokenFaucetContract_3_1_0, any, Promise<number>>(
          self,
          _to,
          _value,
          estimateGasFactor,
  ...
  public transferFrom = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.transferFrom.estimateGasAsync.bind<PolyTokenFaucetContract_3_1_0, any, Promise<number>>(
          self,
          _from,
          _to,
          _value,
  ...
  public approve = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.approve.estimateGasAsync.bind<PolyTokenFaucetContract_3_1_0, any, Promise<number>>(
          self,
          _spender,
          _value,
          estimateGasFactor,
  ...
  public increaseApproval = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.increaseApproval.estimateGasAsync.bind<PolyTokenFaucetContract_3_1_0, any, Promise<number>>(
          self,
          _spender,
          _addedValue,
          estimateGasFactor,
  ...
  public decreaseApproval = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.decreaseApproval.estimateGasAsync.bind<PolyTokenFaucetContract_3_1_0, any, Promise<number>>(
          self,
          _spender,
          _subtractedValue,
          estimateGasFactor,
  ...
  public static async deployAsync(
  ...
  ): Promise<PolyTokenFaucetContract_3_1_0> {
    ...
    const contractInstance = new PolyTokenFaucetContract_3_1_0(
  ...
  constructor(
    ...
    super('PolyTokenFaucet', PolyTokenFaucetContract_3_1_0.ABI(), address, supportedProvider, txDefaults);
...
export function isPolyTokenFaucetContract_3_1_0(contract: any): contract is PolyTokenFaucetContract_3_1_0 {
  return isEqual(PolyTokenFaucetContract_3_1_0.ABI(), contract.abi);
}
