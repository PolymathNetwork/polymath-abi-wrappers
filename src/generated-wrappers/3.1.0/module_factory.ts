...
export type ModuleFactoryEventArgs_3_1_0 =
  | ModuleFactoryOwnershipTransferredEventArgs_3_1_0
  | ModuleFactoryChangeSetupCostEventArgs_3_1_0
  | ModuleFactoryChangeCostTypeEventArgs_3_1_0
  | ModuleFactoryGenerateModuleFromFactoryEventArgs_3_1_0
  | ModuleFactoryChangeSTVersionBoundEventArgs_3_1_0;

export enum ModuleFactoryEvents_3_1_0 {
...
export interface ModuleFactoryOwnershipTransferredEventArgs_3_1_0 extends DecodedLogArgs {
  previousOwner: string;
  newOwner: string;
}
export interface ModuleFactoryChangeSetupCostEventArgs_3_1_0 extends DecodedLogArgs {
  _oldSetupCost: BigNumber;
  _newSetupCost: BigNumber;
}
export interface ModuleFactoryChangeCostTypeEventArgs_3_1_0 extends DecodedLogArgs {
  _isOldCostInPoly: boolean;
  _isNewCostInPoly: boolean;
}
export interface ModuleFactoryGenerateModuleFromFactoryEventArgs_3_1_0 extends DecodedLogArgs {
  _module: string;
  _moduleName: string;
...
export interface ModuleFactoryChangeSTVersionBoundEventArgs_3_1_0 extends DecodedLogArgs {
  _boundType: string;
  _major: BigNumber;
  _minor: BigNumber;
  _patch: BigNumber;
...
export class ModuleFactoryContract_3_1_0 extends BaseContract {
  ...
  public deploy = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as ModuleFactoryContract_3_1_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.deploy.estimateGasAsync.bind<ModuleFactoryContract_3_1_0, any, Promise<number>>(
          self,
          _data,
          estimateGasFactor,
        ),
  ...
  public renounceOwnership = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.renounceOwnership.estimateGasAsync.bind<ModuleFactoryContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public transferOwnership = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.transferOwnership.estimateGasAsync.bind<ModuleFactoryContract_3_1_0, any, Promise<number>>(
          self,
          newOwner,
          estimateGasFactor,
        ),
  ...
  public changeSetupCost = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeSetupCost.estimateGasAsync.bind<ModuleFactoryContract_3_1_0, any, Promise<number>>(
          self,
          _setupCost,
          estimateGasFactor,
        ),
  ...
  public changeCostAndType = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeCostAndType.estimateGasAsync.bind<ModuleFactoryContract_3_1_0, any, Promise<number>>(
          self,
          _setupCost,
          _isCostInPoly,
          estimateGasFactor,
  ...
  public changeTitle = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeTitle.estimateGasAsync.bind<ModuleFactoryContract_3_1_0, any, Promise<number>>(
          self,
          _title,
          estimateGasFactor,
        ),
  ...
  public changeDescription = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeDescription.estimateGasAsync.bind<ModuleFactoryContract_3_1_0, any, Promise<number>>(
          self,
          _description,
          estimateGasFactor,
        ),
  ...
  public changeName = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeName.estimateGasAsync.bind<ModuleFactoryContract_3_1_0, any, Promise<number>>(
          self,
          _name,
          estimateGasFactor,
        ),
  ...
  public changeTags = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeTags.estimateGasAsync.bind<ModuleFactoryContract_3_1_0, any, Promise<number>>(
          self,
          _tagsData,
          estimateGasFactor,
        ),
  ...
  public changeSTVersionBounds = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeSTVersionBounds.estimateGasAsync.bind<ModuleFactoryContract_3_1_0, any, Promise<number>>(
          self,
          _boundType,
          _newVersion,
          estimateGasFactor,
  ...
  public setupCostInPoly = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.setupCostInPoly.estimateGasAsync.bind<ModuleFactoryContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public static async deployAsync(
    ...
    _isCostInPoly: boolean,
  ): Promise<ModuleFactoryContract_3_1_0> {
    ...
    const contractInstance = new ModuleFactoryContract_3_1_0(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('ModuleFactory', ModuleFactoryContract_3_1_0.ABI(), address, supportedProvider, txDefaults);
...
export function isModuleFactoryContract_3_1_0(contract: any): contract is ModuleFactoryContract_3_1_0 {
  return isEqual(ModuleFactoryContract_3_1_0.ABI(), contract.abi);
}
