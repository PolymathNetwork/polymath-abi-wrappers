...
export type RestrictedPartialSaleTMEventArgs_3_1_0 =
...
export enum RestrictedPartialSaleTMEvents_3_1_0 {
...
export class RestrictedPartialSaleTMContract_3_1_0 extends BaseContract {
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as RestrictedPartialSaleTMContract_3_1_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<RestrictedPartialSaleTMContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<RestrictedPartialSaleTMContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<RestrictedPartialSaleTMContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<RestrictedPartialSaleTMContract_3_1_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public configure = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.configure.estimateGasAsync.bind<RestrictedPartialSaleTMContract_3_1_0, any, Promise<number>>(
          self,
          _treasuryWallet,
          estimateGasFactor,
        ),
  ...
  public executeTransfer = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.executeTransfer.estimateGasAsync.bind<RestrictedPartialSaleTMContract_3_1_0, any, Promise<number>>(
          self,
          _from,
          index_1,
          _amount,
  ...
  public changeExemptWalletList = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeExemptWalletList.estimateGasAsync.bind<RestrictedPartialSaleTMContract_3_1_0, any, Promise<number>>(
          self,
          _wallet,
          _exempted,
          estimateGasFactor,
  ...
  public changeExemptWalletListMulti = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeExemptWalletListMulti.estimateGasAsync.bind<
          RestrictedPartialSaleTMContract_3_1_0,
          any,
          Promise<number>
        >(self, _wallet, _exempted, estimateGasFactor),
      );
      if (txDataWithDefaults.from !== undefined) {
        txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
      }
  ...
  public static async deployAsync(
    ...
    _polyAddress: string,
  ): Promise<RestrictedPartialSaleTMContract_3_1_0> {
    ...
    const contractInstance = new RestrictedPartialSaleTMContract_3_1_0(
...
export function isRestrictedPartialSaleTMContract_3_1_0(
  contract: any,
): contract is RestrictedPartialSaleTMContract_3_1_0 {
  return isEqual(RestrictedPartialSaleTMContract_3_1_0.ABI(), contract.abi);
}
