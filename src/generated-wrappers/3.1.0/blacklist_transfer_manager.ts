...
export type BlacklistTransferManagerEventArgs_3_1_0 =
  | BlacklistTransferManagerAddBlacklistTypeEventArgs_3_1_0
  | BlacklistTransferManagerModifyBlacklistTypeEventArgs_3_1_0
  | BlacklistTransferManagerDeleteBlacklistTypeEventArgs_3_1_0
  | BlacklistTransferManagerAddInvestorToBlacklistEventArgs_3_1_0
  | BlacklistTransferManagerDeleteInvestorFromBlacklistEventArgs_3_1_0
  | BlacklistTransferManagerPauseEventArgs_3_1_0
  | BlacklistTransferManagerUnpauseEventArgs_3_1_0;

export enum BlacklistTransferManagerEvents_3_1_0 {
...
export interface BlacklistTransferManagerAddBlacklistTypeEventArgs_3_1_0 extends DecodedLogArgs {
  _startTime: BigNumber;
  _endTime: BigNumber;
  _blacklistName: string;
  _repeatPeriodTime: BigNumber;
}
export interface BlacklistTransferManagerModifyBlacklistTypeEventArgs_3_1_0 extends DecodedLogArgs {
  _startTime: BigNumber;
  _endTime: BigNumber;
  _blacklistName: string;
  _repeatPeriodTime: BigNumber;
}
export interface BlacklistTransferManagerDeleteBlacklistTypeEventArgs_3_1_0 extends DecodedLogArgs {
  _blacklistName: string;
}
export interface BlacklistTransferManagerAddInvestorToBlacklistEventArgs_3_1_0 extends DecodedLogArgs {
  _investor: string;
  _blacklistName: string;
}
export interface BlacklistTransferManagerDeleteInvestorFromBlacklistEventArgs_3_1_0 extends DecodedLogArgs {
  _investor: string;
  _blacklistName: string;
}
export interface BlacklistTransferManagerPauseEventArgs_3_1_0 extends DecodedLogArgs {
  account: string;
}
export interface BlacklistTransferManagerUnpauseEventArgs_3_1_0 extends DecodedLogArgs {
  account: string;
}
...
export class BlacklistTransferManagerContract_3_1_0 extends BaseContract {
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as BlacklistTransferManagerContract_3_1_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<BlacklistTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<BlacklistTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<BlacklistTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<BlacklistTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public executeTransfer = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.executeTransfer.estimateGasAsync.bind<BlacklistTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _from,
          index_1,
          index_2,
  ...
  public addBlacklistType = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addBlacklistType.estimateGasAsync.bind<BlacklistTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _startTime,
          _endTime,
          _blacklistName,
  ...
  public addBlacklistTypeMulti = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addBlacklistTypeMulti.estimateGasAsync.bind<BlacklistTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _startTimes,
          _endTimes,
          _blacklistNames,
  ...
  public modifyBlacklistType = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.modifyBlacklistType.estimateGasAsync.bind<BlacklistTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _startTime,
          _endTime,
          _blacklistName,
  ...
  public modifyBlacklistTypeMulti = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.modifyBlacklistTypeMulti.estimateGasAsync.bind<
          BlacklistTransferManagerContract_3_1_0,
          any,
          Promise<number>
        >(self, _startTimes, _endTimes, _blacklistNames, _repeatPeriodTimes, estimateGasFactor),
      );
      if (txDataWithDefaults.from !== undefined) {
        txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
      }
  ...
  public deleteBlacklistType = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.deleteBlacklistType.estimateGasAsync.bind<BlacklistTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _blacklistName,
          estimateGasFactor,
        ),
  ...
  public deleteBlacklistTypeMulti = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.deleteBlacklistTypeMulti.estimateGasAsync.bind<
          BlacklistTransferManagerContract_3_1_0,
          any,
          Promise<number>
        >(self, _blacklistNames, estimateGasFactor),
      );
      if (txDataWithDefaults.from !== undefined) {
        txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
      }
  ...
  public addInvestorToBlacklist = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addInvestorToBlacklist.estimateGasAsync.bind<BlacklistTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _investor,
          _blacklistName,
          estimateGasFactor,
  ...
  public addInvestorToBlacklistMulti = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addInvestorToBlacklistMulti.estimateGasAsync.bind<
          BlacklistTransferManagerContract_3_1_0,
          any,
          Promise<number>
        >(self, _investors, _blacklistName, estimateGasFactor),
      );
      if (txDataWithDefaults.from !== undefined) {
        txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
      }
  ...
  public addInvestorToNewBlacklist = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addInvestorToNewBlacklist.estimateGasAsync.bind<
          BlacklistTransferManagerContract_3_1_0,
          any,
          Promise<number>
        >(self, _startTime, _endTime, _blacklistName, _repeatPeriodTime, _investor, estimateGasFactor),
      );
      if (txDataWithDefaults.from !== undefined) {
        txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
      }
  ...
  public deleteInvestorFromBlacklist = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.deleteInvestorFromBlacklist.estimateGasAsync.bind<
          BlacklistTransferManagerContract_3_1_0,
          any,
          Promise<number>
        >(self, _investor, _blacklistName, estimateGasFactor),
      );
      if (txDataWithDefaults.from !== undefined) {
        txDataWithDefaults.from = txDataWithDefaults.from.toLowerCase();
      }
  ...
  public static async deployAsync(
    ...
    _polyAddress: string,
  ): Promise<BlacklistTransferManagerContract_3_1_0> {
    ...
    const contractInstance = new BlacklistTransferManagerContract_3_1_0(
  ...
  constructor(
    ...
    super(
      ...
      BlacklistTransferManagerContract_3_1_0.ABI(),
      address,
      supportedProvider,
      txDefaults,
    );
...
export function isBlacklistTransferManagerContract_3_1_0(
  contract: any,
): contract is BlacklistTransferManagerContract_3_1_0 {
  return isEqual(BlacklistTransferManagerContract_3_1_0.ABI(), contract.abi);
}
