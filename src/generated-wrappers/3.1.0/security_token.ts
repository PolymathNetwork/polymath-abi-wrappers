...
export function isSecurityTokenContract_3_1_0(contract: any): contract is SecurityTokenContract_3_1_0 {
  return isEqual(SecurityTokenContract_3_1_0.ABI(), contract.abi);
}
