...
export type VestingEscrowWalletEventArgs_3_1_0 =
...
export enum VestingEscrowWalletEvents_3_1_0 {
...
export interface VestingEscrowWalletAddScheduleEventArgs_3_1_0 extends DecodedLogArgs {
  _beneficiary: string;
  _templateName: string;
  _startTime: BigNumber;
}
export interface VestingEscrowWalletModifyScheduleEventArgs_3_1_0 extends DecodedLogArgs {
  _beneficiary: string;
  _templateName: string;
  _startTime: BigNumber;
}
export interface VestingEscrowWalletRevokeAllSchedulesEventArgs_3_1_0 extends DecodedLogArgs {
  _beneficiary: string;
}
export interface VestingEscrowWalletRevokeScheduleEventArgs_3_1_0 extends DecodedLogArgs {
  _beneficiary: string;
  _templateName: string;
}
export interface VestingEscrowWalletDepositTokensEventArgs_3_1_0 extends DecodedLogArgs {
  _numberOfTokens: BigNumber;
  _sender: string;
}
export interface VestingEscrowWalletSendToTreasuryEventArgs_3_1_0 extends DecodedLogArgs {
  _numberOfTokens: BigNumber;
  _sender: string;
}
export interface VestingEscrowWalletSendTokensEventArgs_3_1_0 extends DecodedLogArgs {
  _beneficiary: string;
  _numberOfTokens: BigNumber;
}
export interface VestingEscrowWalletAddTemplateEventArgs_3_1_0 extends DecodedLogArgs {
  _name: string;
  _numberOfTokens: BigNumber;
  _duration: BigNumber;
  _frequency: BigNumber;
}
export interface VestingEscrowWalletRemoveTemplateEventArgs_3_1_0 extends DecodedLogArgs {
  _name: string;
}
export interface VestingEscrowWalletTreasuryWalletChangedEventArgs_3_1_0 extends DecodedLogArgs {
  _newWallet: string;
  _oldWallet: string;
}
export interface VestingEscrowWalletPauseEventArgs_3_1_0 extends DecodedLogArgs {
  account: string;
}
export interface VestingEscrowWalletUnpauseEventArgs_3_1_0 extends DecodedLogArgs {
  account: string;
}
...
export class VestingEscrowWalletContract_3_1_0 extends BaseContract {
  ...
  public templates = {
    async callAsync(
      ...
      const self = (this as any) as VestingEscrowWalletContract_3_1_0;
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public configure = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.configure.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _treasuryWallet,
          estimateGasFactor,
        ),
  ...
  public changeTreasuryWallet = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeTreasuryWallet.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _newTreasuryWallet,
          estimateGasFactor,
        ),
  ...
  public depositTokens = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.depositTokens.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _numberOfTokens,
          estimateGasFactor,
        ),
  ...
  public sendToTreasury = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.sendToTreasury.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _amount,
          estimateGasFactor,
        ),
  ...
  public pushAvailableTokens = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pushAvailableTokens.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _beneficiary,
          estimateGasFactor,
        ),
  ...
  public pullAvailableTokens = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pullAvailableTokens.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public addTemplate = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addTemplate.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _name,
          _numberOfTokens,
          _duration,
  ...
  public removeTemplate = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.removeTemplate.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _name,
          estimateGasFactor,
        ),
  ...
  public addSchedule = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addSchedule.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _beneficiary,
          _templateName,
          _numberOfTokens,
  ...
  public addScheduleFromTemplate = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addScheduleFromTemplate.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _beneficiary,
          _templateName,
          _startTime,
  ...
  public modifySchedule = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.modifySchedule.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _beneficiary,
          _templateName,
          _startTime,
  ...
  public revokeSchedule = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.revokeSchedule.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _beneficiary,
          _templateName,
          estimateGasFactor,
  ...
  public revokeAllSchedules = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.revokeAllSchedules.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _beneficiary,
          estimateGasFactor,
        ),
  ...
  public pushAvailableTokensMulti = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pushAvailableTokensMulti.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _fromIndex,
          _toIndex,
          estimateGasFactor,
  ...
  public addScheduleMulti = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addScheduleMulti.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _beneficiaries,
          _templateNames,
          _numberOfTokens,
  ...
  public revokeSchedulesMulti = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.revokeSchedulesMulti.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _beneficiaries,
          estimateGasFactor,
        ),
  ...
  public modifyScheduleMulti = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.modifyScheduleMulti.estimateGasAsync.bind<VestingEscrowWalletContract_3_1_0, any, Promise<number>>(
          self,
          _beneficiaries,
          _templateNames,
          _startTimes,
  ...
  public static async deployAsync(
    ...
    _polyAddress: string,
  ): Promise<VestingEscrowWalletContract_3_1_0> {
    ...
    const contractInstance = new VestingEscrowWalletContract_3_1_0(
  ...
  constructor(
    ...
    super('VestingEscrowWallet', VestingEscrowWalletContract_3_1_0.ABI(), address, supportedProvider, txDefaults);
...
export function isVestingEscrowWalletContract_3_1_0(contract: any): contract is VestingEscrowWalletContract_3_1_0 {
  return isEqual(VestingEscrowWalletContract_3_1_0.ABI(), contract.abi);
}
