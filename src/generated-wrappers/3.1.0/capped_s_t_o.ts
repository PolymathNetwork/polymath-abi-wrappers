...
export type CappedSTOEventArgs_3_1_0 =
...
export enum CappedSTOEvents_3_1_0 {
...
export class CappedSTOContract_3_1_0 extends BaseContract {
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as CappedSTOContract_3_1_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<CappedSTOContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public rate = {
    ...
    getABIEncodedTransactionData(): string {
      const self = (this as any) as CappedSTOContract_3_1_0;
      const abiEncodedTransactionData = self._strictEncodeArguments('rate()', []);
      return abiEncodedTransactionData;
    },
  };
  ...
  public cap = {
    ...
    getABIEncodedTransactionData(): string {
      const self = (this as any) as CappedSTOContract_3_1_0;
      const abiEncodedTransactionData = self._strictEncodeArguments('cap()', []);
      return abiEncodedTransactionData;
    },
  };
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<CappedSTOContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public investors = {
    ...
    getABIEncodedTransactionData(index_0: string): string {
      assert.isString('index_0', index_0);
      const self = (this as any) as CappedSTOContract_3_1_0;
      const abiEncodedTransactionData = self._strictEncodeArguments('investors(address)', [index_0]);
      return abiEncodedTransactionData;
    },
  };
  public polyToken = {
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<CappedSTOContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<CappedSTOContract_3_1_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public configure = {
    async sendTransactionAsync(
      ...
      assert.isBigNumber('_cap', _cap);
      assert.isBigNumber('_rate', _rate);
      assert.isArray('_fundRaiseTypes', _fundRaiseTypes);
      assert.isString('_fundsReceiver', _fundsReceiver);
      assert.isString('_treasuryWallet', _treasuryWallet);
      const self = (this as any) as CappedSTOContract_3_1_0;
      const encodedData = self._strictEncodeArguments(
        'configure(uint256,uint256,uint256,uint256,uint8[],address,address)',
        [_startTime, _endTime, _cap, _rate, _fundRaiseTypes, _fundsReceiver, _treasuryWallet],
      );
      const contractDefaults = self._web3Wrapper.getContractDefaults();
      const defaultFromAddress = (await self._web3Wrapper.getAvailableAddressesAsync())[0];
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.configure.estimateGasAsync.bind<CappedSTOContract_3_1_0, any, Promise<number>>(
          self,
          _startTime,
          _endTime,
          _cap,
    ...
    async callAsync(
      ...
      const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
      BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
      const abiEncoder = self._lookupAbiEncoder('configure(uint256,uint256,uint256,uint256,uint8[],address,address)');
      // tslint:disable boolean-naming
      const result = abiEncoder.strictDecodeReturnValue<void>(rawCallResult);
      // tslint:enable boolean-naming
      return result;
  ...
  public allowPreMinting = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.allowPreMinting.estimateGasAsync.bind<CappedSTOContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public revokePreMintFlag = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.revokePreMintFlag.estimateGasAsync.bind<CappedSTOContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public changeAllowBeneficialInvestments = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.changeAllowBeneficialInvestments.estimateGasAsync.bind<CappedSTOContract_3_1_0, any, Promise<number>>(
          self,
          _allowBeneficialInvestments,
          estimateGasFactor,
        ),
  ...
  public buyTokens = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.buyTokens.estimateGasAsync.bind<CappedSTOContract_3_1_0, any, Promise<number>>(
          self,
          _beneficiary,
          estimateGasFactor,
        ),
    ...
    getABIEncodedTransactionData(_beneficiary: string): string {
      assert.isString('_beneficiary', _beneficiary);
      const self = (this as any) as CappedSTOContract_3_1_0;
      const abiEncodedTransactionData = self._strictEncodeArguments('buyTokens(address)', [_beneficiary]);
      return abiEncodedTransactionData;
    },
  };
  public buyTokensWithPoly = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.buyTokensWithPoly.estimateGasAsync.bind<CappedSTOContract_3_1_0, any, Promise<number>>(
          self,
          _investedPOLY,
          estimateGasFactor,
        ),
    ...
    getABIEncodedTransactionData(_investedPOLY: BigNumber): string {
      assert.isBigNumber('_investedPOLY', _investedPOLY);
      const self = (this as any) as CappedSTOContract_3_1_0;
      const abiEncodedTransactionData = self._strictEncodeArguments('buyTokensWithPoly(uint256)', [_investedPOLY]);
      return abiEncodedTransactionData;
    },
  };
  public capReached = {
  ...
  public getSTODetails = {
    async callAsync(
      callData: Partial<CallData> = {},
      defaultBlock?: BlockParam,
    ): Promise<[BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, boolean, boolean]> {
      assert.doesConformToSchema('callData', callData, schemas.callDataSchema, [
        schemas.addressSchema,
        schemas.numberSchema,
        schemas.jsNumber,
  ...
  public finalize = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.finalize.estimateGasAsync.bind<CappedSTOContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public static async deployAsync(
    ...
    _polyToken: string,
  ): Promise<CappedSTOContract_3_1_0> {
    ...
    const contractInstance = new CappedSTOContract_3_1_0(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('CappedSTO', CappedSTOContract_3_1_0.ABI(), address, supportedProvider, txDefaults);
...
export function isCappedSTOContract_3_1_0(contract: any): contract is CappedSTOContract_3_1_0 {
  return isEqual(CappedSTOContract_3_1_0.ABI(), contract.abi);
}
