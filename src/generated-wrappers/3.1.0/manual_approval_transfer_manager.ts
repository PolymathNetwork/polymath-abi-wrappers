...
export type ManualApprovalTransferManagerEventArgs_3_1_0 =
  | ManualApprovalTransferManagerAddManualApprovalEventArgs_3_1_0
  | ManualApprovalTransferManagerModifyManualApprovalEventArgs_3_1_0
  | ManualApprovalTransferManagerRevokeManualApprovalEventArgs_3_1_0
  | ManualApprovalTransferManagerPauseEventArgs_3_1_0
  | ManualApprovalTransferManagerUnpauseEventArgs_3_1_0;

export enum ManualApprovalTransferManagerEvents_3_1_0 {
...
export interface ManualApprovalTransferManagerAddManualApprovalEventArgs_3_1_0 extends DecodedLogArgs {
  _from: string;
  _to: string;
...
export interface ManualApprovalTransferManagerModifyManualApprovalEventArgs_3_1_0 extends DecodedLogArgs {
  _from: string;
  _to: string;
  _expiryTime: BigNumber;
  _allowance: BigNumber;
...
export interface ManualApprovalTransferManagerRevokeManualApprovalEventArgs_3_1_0 extends DecodedLogArgs {
  _from: string;
  _to: string;
  _addedBy: string;
}
export interface ManualApprovalTransferManagerPauseEventArgs_3_1_0 extends DecodedLogArgs {
  account: string;
}
export interface ManualApprovalTransferManagerUnpauseEventArgs_3_1_0 extends DecodedLogArgs {
  account: string;
}
...
export class ManualApprovalTransferManagerContract_3_1_0 extends BaseContract {
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as ManualApprovalTransferManagerContract_3_1_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<ManualApprovalTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<ManualApprovalTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<ManualApprovalTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<ManualApprovalTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public executeTransfer = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.executeTransfer.estimateGasAsync.bind<ManualApprovalTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _from,
          _to,
          _amount,
  ...
  public addManualApproval = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addManualApproval.estimateGasAsync.bind<ManualApprovalTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _from,
          _to,
          _allowance,
    ...
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.addManualApprovalMulti.estimateGasAsync.bind<
          ManualApprovalTransferManagerContract_3_1_0,
          any,
          Promise<number>
  ...
  public static async deployAsync(
    ...
    _polyToken: string,
  ): Promise<ManualApprovalTransferManagerContract_3_1_0> {
    ...
    const contractInstance = new ManualApprovalTransferManagerContract_3_1_0(
  ...
  constructor(
    ...
    super(
      ...
      ManualApprovalTransferManagerContract_3_1_0.ABI(),
      address,
      supportedProvider,
      txDefaults,
    );
...
export function isManualApprovalTransferManagerContract_3_1_0(
  contract: any,
): contract is ManualApprovalTransferManagerContract_3_1_0 {
  return isEqual(ManualApprovalTransferManagerContract_3_1_0.ABI(), contract.abi);
}
