...
export type FeatureRegistryEventArgs_3_1_0 =
  | FeatureRegistryOwnershipTransferredEventArgs_3_1_0
  | FeatureRegistryChangeFeatureStatusEventArgs_3_1_0;

export enum FeatureRegistryEvents_3_1_0 {
...
export class FeatureRegistryContract_3_1_0 extends BaseContract {
  ...
  public renounceOwnership = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as FeatureRegistryContract_3_1_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.renounceOwnership.estimateGasAsync.bind<FeatureRegistryContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<FeatureRegistryContract_3_1_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public transferOwnership = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.transferOwnership.estimateGasAsync.bind<FeatureRegistryContract_3_1_0, any, Promise<number>>(
          self,
          newOwner,
          estimateGasFactor,
        ),
  ...
  public setFeatureStatus = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.setFeatureStatus.estimateGasAsync.bind<FeatureRegistryContract_3_1_0, any, Promise<number>>(
          self,
          _nameKey,
          _newStatus,
          estimateGasFactor,
  ...
  public static async deployAsync(
  ...
  ): Promise<FeatureRegistryContract_3_1_0> {
    ...
    const contractInstance = new FeatureRegistryContract_3_1_0(
  ...
  constructor(
    ...
    super('FeatureRegistry', FeatureRegistryContract_3_1_0.ABI(), address, supportedProvider, txDefaults);
...
export function isFeatureRegistryContract_3_1_0(contract: any): contract is FeatureRegistryContract_3_1_0 {
  return isEqual(FeatureRegistryContract_3_1_0.ABI(), contract.abi);
}
