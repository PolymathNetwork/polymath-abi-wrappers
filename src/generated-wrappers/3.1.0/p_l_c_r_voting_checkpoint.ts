...
export function isPLCRVotingCheckpointContract_3_1_0(contract: any): contract is PLCRVotingCheckpointContract_3_1_0 {
  return isEqual(PLCRVotingCheckpointContract_3_1_0.ABI(), contract.abi);
}
