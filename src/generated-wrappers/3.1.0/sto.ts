...
export type STOEventArgs_3_1_0 =
  | STOPauseEventArgs_3_1_0
  | STOUnpauseEventArgs_3_1_0
  | STOSetFundRaiseTypesEventArgs_3_1_0
  | STORevokePreMintFlagEventArgs_3_1_0
  | STOAllowPreMintFlagEventArgs_3_1_0;

export enum STOEvents_3_1_0 {
  Pause = 'Pause',
  Unpause = 'Unpause',
...
export class STOContract_3_1_0 extends BaseContract {
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as STOContract_3_1_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<STOContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<STOContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<STOContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<STOContract_3_1_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public static async deployAsync(
    ...
    const contractInstance = new STOContract_3_1_0(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('STO', STOContract_3_1_0.ABI(), address, supportedProvider, txDefaults);
...
export function isSTOContract_3_1_0(contract: any): contract is STOContract_3_1_0 {
  return isEqual(STOContract_3_1_0.ABI(), contract.abi);
}
