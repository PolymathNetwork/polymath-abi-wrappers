...
export type CountTransferManagerEventArgs_3_1_0 =
  | CountTransferManagerModifyHolderCountEventArgs_3_1_0
  | CountTransferManagerPauseEventArgs_3_1_0
  | CountTransferManagerUnpauseEventArgs_3_1_0;

export enum CountTransferManagerEvents_3_1_0 {
  ModifyHolderCount = 'ModifyHolderCount',
  Pause = 'Pause',
  Unpause = 'Unpause',
}

export interface CountTransferManagerModifyHolderCountEventArgs_3_1_0 extends DecodedLogArgs {
  _oldHolderCount: BigNumber;
  _newHolderCount: BigNumber;
}
export interface CountTransferManagerPauseEventArgs_3_1_0 extends DecodedLogArgs {
  account: string;
}
export interface CountTransferManagerUnpauseEventArgs_3_1_0 extends DecodedLogArgs {
  account: string;
}
...
export class CountTransferManagerContract_3_1_0 extends BaseContract {
  ...
  public reclaimETH = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as CountTransferManagerContract_3_1_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimETH.estimateGasAsync.bind<CountTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public unpause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.unpause.estimateGasAsync.bind<CountTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public pause = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.pause.estimateGasAsync.bind<CountTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public reclaimERC20 = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.reclaimERC20.estimateGasAsync.bind<CountTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _tokenContract,
          estimateGasFactor,
        ),
  ...
  public maxHolderCount = {
    async callAsync(callData: Partial<CallData> = {}, defaultBlock?: BlockParam): Promise<BigNumber> {
      ...
      const self = (this as any) as CountTransferManagerContract_3_1_0;
      const encodedData = self._strictEncodeArguments('maxHolderCount()', []);
      const callDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        {
          to: self.address,
          ...callData,
      ...
      const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
      BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
      const abiEncoder = self._lookupAbiEncoder('maxHolderCount()');
      // tslint:disable boolean-naming
      const result = abiEncoder.strictDecodeReturnValue<BigNumber>(rawCallResult);
      // tslint:enable boolean-naming
      return result;
    ...
    getABIEncodedTransactionData(): string {
      const self = (this as any) as CountTransferManagerContract_3_1_0;
      const abiEncodedTransactionData = self._strictEncodeArguments('maxHolderCount()', []);
      return abiEncodedTransactionData;
    },
  };
  ...
  public executeTransfer = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.executeTransfer.estimateGasAsync.bind<CountTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _from,
          _to,
          _amount,
  ...
  public configure = {
    async sendTransactionAsync(
      ...
      assert.isBigNumber('_maxHolderCount', _maxHolderCount);
      const self = (this as any) as CountTransferManagerContract_3_1_0;
      const encodedData = self._strictEncodeArguments('configure(uint256)', [_maxHolderCount]);
      const contractDefaults = self._web3Wrapper.getContractDefaults();
      const defaultFromAddress = (await self._web3Wrapper.getAvailableAddressesAsync())[0];
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        {
        ...
        self.configure.estimateGasAsync.bind<CountTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _maxHolderCount,
          estimateGasFactor,
        ),
    ...
    async callAsync(
      ...
      const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
      BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
      const abiEncoder = self._lookupAbiEncoder('configure(uint256)');
      // tslint:disable boolean-naming
      const result = abiEncoder.strictDecodeReturnValue<void>(rawCallResult);
      // tslint:enable boolean-naming
      return result;
    ...
    getABIEncodedTransactionData(_maxHolderCount: BigNumber): string {
      assert.isBigNumber('_maxHolderCount', _maxHolderCount);
      const self = (this as any) as CountTransferManagerContract_3_1_0;
      const abiEncodedTransactionData = self._strictEncodeArguments('configure(uint256)', [_maxHolderCount]);
      return abiEncodedTransactionData;
    },
  };
  public changeHolderCount = {
    async sendTransactionAsync(
      ...
      assert.isBigNumber('_maxHolderCount', _maxHolderCount);
      const self = (this as any) as CountTransferManagerContract_3_1_0;
      const encodedData = self._strictEncodeArguments('changeHolderCount(uint256)', [_maxHolderCount]);
      const contractDefaults = self._web3Wrapper.getContractDefaults();
      const defaultFromAddress = (await self._web3Wrapper.getAvailableAddressesAsync())[0];
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        {
        ...
        self.changeHolderCount.estimateGasAsync.bind<CountTransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _maxHolderCount,
          estimateGasFactor,
        ),
    ...
    async callAsync(
      ...
      const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
      BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
      const abiEncoder = self._lookupAbiEncoder('changeHolderCount(uint256)');
      // tslint:disable boolean-naming
      const result = abiEncoder.strictDecodeReturnValue<void>(rawCallResult);
      // tslint:enable boolean-naming
      return result;
    ...
    getABIEncodedTransactionData(_maxHolderCount: BigNumber): string {
      assert.isBigNumber('_maxHolderCount', _maxHolderCount);
      const self = (this as any) as CountTransferManagerContract_3_1_0;
      const abiEncodedTransactionData = self._strictEncodeArguments('changeHolderCount(uint256)', [_maxHolderCount]);
      return abiEncodedTransactionData;
    },
  };
  ...
  public static async deployAsync(
    ...
    _polyToken: string,
  ): Promise<CountTransferManagerContract_3_1_0> {
    ...
    logUtils.log(`CountTransferManager successfully deployed at ${txReceipt.contractAddress}`);
    const contractInstance = new CountTransferManagerContract_3_1_0(
  ...
  constructor(
    ...
    super('CountTransferManager', CountTransferManagerContract_3_1_0.ABI(), address, supportedProvider, txDefaults);
...
export function isCountTransferManagerContract_3_1_0(contract: any): contract is CountTransferManagerContract_3_1_0 {
  return isEqual(CountTransferManagerContract_3_1_0.ABI(), contract.abi);
}
