...
export type OwnableEventArgs_3_1_0 = OwnableOwnershipTransferredEventArgs_3_1_0;

export enum OwnableEvents_3_1_0 {
  OwnershipTransferred = 'OwnershipTransferred',
}

export interface OwnableOwnershipTransferredEventArgs_3_1_0 extends DecodedLogArgs {
...
export class OwnableContract_3_1_0 extends BaseContract {
  ...
  public owner = {
    async callAsync(callData: Partial<CallData> = {}, defaultBlock?: BlockParam): Promise<string> {
      ...
      const self = (this as any) as OwnableContract_3_1_0;
  ...
  public renounceOwnership = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.renounceOwnership.estimateGasAsync.bind<OwnableContract_3_1_0, any, Promise<number>>(
          self,
  ...
  public transferOwnership = {
    async sendTransactionAsync(
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.transferOwnership.estimateGasAsync.bind<OwnableContract_3_1_0, any, Promise<number>>(
          self,
          newOwner,
          estimateGasFactor,
        ),
  ...
  public static async deployAsync(
    ...
    const contractInstance = new OwnableContract_3_1_0(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    super('Ownable', OwnableContract_3_1_0.ABI(), address, supportedProvider, txDefaults);
...
export function isOwnableContract_3_1_0(contract: any): contract is OwnableContract_3_1_0 {
  return isEqual(OwnableContract_3_1_0.ABI(), contract.abi);
}
