...
export class ITransferManagerContract_3_1_0 extends BaseContract {
  ...
  public executeTransfer = {
    async sendTransactionAsync(
      ...
      const self = (this as any) as ITransferManagerContract_3_1_0;
      ...
      const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
        ...
        self.executeTransfer.estimateGasAsync.bind<ITransferManagerContract_3_1_0, any, Promise<number>>(
          self,
          _from,
          _to,
          _amount,
  ...
  public static async deployAsync(
  ...
  ): Promise<ITransferManagerContract_3_1_0> {
    ...
    const contractInstance = new ITransferManagerContract_3_1_0(
  ...
  constructor(
    ...
    super('ITransferManager', ITransferManagerContract_3_1_0.ABI(), address, supportedProvider, txDefaults);
...
export function isITransferManagerContract_3_1_0(contract: any): contract is ITransferManagerContract_3_1_0 {
  return isEqual(ITransferManagerContract_3_1_0.ABI(), contract.abi);
}
