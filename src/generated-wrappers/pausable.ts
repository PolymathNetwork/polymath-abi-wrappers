...
export type PausableEventArgs = PausablePauseEventArgs | PausableUnpauseEventArgs;
...
export class PausableContract extends BaseContract {
  ...
  public static async deployAsync(
    ...
    const contractInstance = new PausableContract(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    this._web3Wrapper.abiDecoder.addABI(PausableContract.ABI(), '{contractName}');
