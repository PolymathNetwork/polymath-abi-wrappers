...
export type ERC20DetailedEventArgs = ERC20DetailedTransferEventArgs | ERC20DetailedApprovalEventArgs;
...
export class ERC20DetailedContract extends BaseContract {
  ...
  public static async deployAsync(
    ...
    const contractInstance = new ERC20DetailedContract(txReceipt.contractAddress as string, provider, txDefaults);
  ...
  constructor(
    ...
    this._web3Wrapper.abiDecoder.addABI(ERC20DetailedContract.ABI());
