...
export declare type SecurityTokenRegistryEventArgs_3_1_0 = SecurityTokenRegistryPauseEventArgs_3_1_0 | SecurityTokenRegistryUnpauseEventArgs_3_1_0 | SecurityTokenRegistryTickerRemovedEventArgs_3_1_0 | SecurityTokenRegistryChangeExpiryLimitEventArgs_3_1_0 | SecurityTokenRegistryChangeSecurityLaunchFeeEventArgs_3_1_0 | SecurityTokenRegistryChangeTickerRegistrationFeeEventArgs_3_1_0 | SecurityTokenRegistryChangeFeeCurrencyEventArgs_3_1_0 | SecurityTokenRegistryOwnershipTransferredEventArgs_3_1_0 | SecurityTokenRegistryChangeTickerOwnershipEventArgs_3_1_0 | SecurityTokenRegistryNewSecurityTokenEventArgs_3_1_0 | SecurityTokenRegistryNewSecurityTokenEventArgs_3_1_0 | SecurityTokenRegistryRegisterTickerEventArgs_3_1_0 | SecurityTokenRegistryRegisterTickerEventArgs_3_1_0 | SecurityTokenRegistrySecurityTokenRefreshedEventArgs_3_1_0 | SecurityTokenRegistryProtocolFactorySetEventArgs_3_1_0 | SecurityTokenRegistryLatestVersionSetEventArgs_3_1_0 | SecurityTokenRegistryProtocolFactoryRemovedEventArgs_3_1_0;
export declare enum SecurityTokenRegistryEvents_3_1_0 {
    Pause = "Pause",
    Unpause = "Unpause",
...
export declare class SecurityTokenRegistryContract_3_1_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<SecurityTokenRegistryContract_3_1_0>;
    /**
