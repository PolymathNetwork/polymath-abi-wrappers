...
export declare type ModuleFactoryEventArgs_3_1_0 = ModuleFactoryOwnershipTransferredEventArgs_3_1_0 | ModuleFactoryChangeSetupCostEventArgs_3_1_0 | ModuleFactoryChangeCostTypeEventArgs_3_1_0 | ModuleFactoryGenerateModuleFromFactoryEventArgs_3_1_0 | ModuleFactoryChangeSTVersionBoundEventArgs_3_1_0;
export declare enum ModuleFactoryEvents_3_1_0 {
...
export declare class ModuleFactoryContract_3_1_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>, _setupCost: BigNumber, _polymathRegistry: string, _isCostInPoly: boolean): Promise<ModuleFactoryContract_3_1_0>;
    /**
