...
export declare type PolyTokenFaucetEventArgs_3_1_0 = PolyTokenFaucetTransferEventArgs_3_1_0 | PolyTokenFaucetApprovalEventArgs_3_1_0;
export declare enum PolyTokenFaucetEvents_3_1_0 {
    Transfer = "Transfer",
    Approval = "Approval"
}
...
export declare class PolyTokenFaucetContract_3_1_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<PolyTokenFaucetContract_3_1_0>;
    /**
