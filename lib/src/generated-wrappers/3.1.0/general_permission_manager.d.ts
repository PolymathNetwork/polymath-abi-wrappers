...
export declare type GeneralPermissionManagerEventArgs_3_1_0 = GeneralPermissionManagerChangePermissionEventArgs_3_1_0 | GeneralPermissionManagerAddDelegateEventArgs_3_1_0 | GeneralPermissionManagerPauseEventArgs_3_1_0 | GeneralPermissionManagerUnpauseEventArgs_3_1_0;
export declare enum GeneralPermissionManagerEvents_3_1_0 {
...
export declare class GeneralPermissionManagerContract_3_1_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>, _securityToken: string, _polyToken: string): Promise<GeneralPermissionManagerContract_3_1_0>;
    /**
