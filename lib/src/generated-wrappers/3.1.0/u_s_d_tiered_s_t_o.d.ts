...
export declare type USDTieredSTOEventArgs_3_1_0 = USDTieredSTOSetAllowBeneficialInvestmentsEventArgs_3_1_0 | USDTieredSTOSetNonAccreditedLimitEventArgs_3_1_0 | USDTieredSTOTokenPurchaseEventArgs_3_1_0 | USDTieredSTOFundsReceivedEventArgs_3_1_0 | USDTieredSTOReserveTokenMintEventArgs_3_1_0 | USDTieredSTOReserveTokenTransferEventArgs_3_1_0 | USDTieredSTOSetAddressesEventArgs_3_1_0 | USDTieredSTOSetLimitsEventArgs_3_1_0 | USDTieredSTOSetTimesEventArgs_3_1_0 | USDTieredSTOSetTiersEventArgs_3_1_0 | USDTieredSTOSetTreasuryWalletEventArgs_3_1_0 | USDTieredSTOPauseEventArgs_3_1_0 | USDTieredSTOUnpauseEventArgs_3_1_0 | USDTieredSTOSetFundRaiseTypesEventArgs_3_1_0 | USDTieredSTORevokePreMintFlagEventArgs_3_1_0 | USDTieredSTOAllowPreMintFlagEventArgs_3_1_0;
export declare enum USDTieredSTOEvents_3_1_0 {
...
export declare class USDTieredSTOContract_3_1_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>, _securityToken: string, _polyAddress: string): Promise<USDTieredSTOContract_3_1_0>;
    /**
