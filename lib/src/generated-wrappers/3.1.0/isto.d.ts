...
export declare type ISTOEventArgs_3_1_0 = ISTOSetFundRaiseTypesEventArgs_3_1_0 | ISTORevokePreMintFlagEventArgs_3_1_0 | ISTOAllowPreMintFlagEventArgs_3_1_0;
export declare enum ISTOEvents_3_1_0 {
...
export declare class ISTOContract_3_1_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<ISTOContract_3_1_0>;
    /**
