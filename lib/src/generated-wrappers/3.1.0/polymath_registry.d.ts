...
export declare type PolymathRegistryEventArgs_3_1_0 = PolymathRegistryChangeAddressEventArgs_3_1_0 | PolymathRegistryOwnershipTransferredEventArgs_3_1_0;
export declare enum PolymathRegistryEvents_3_1_0 {
...
export declare class PolymathRegistryContract_3_1_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<PolymathRegistryContract_3_1_0>;
    /**
