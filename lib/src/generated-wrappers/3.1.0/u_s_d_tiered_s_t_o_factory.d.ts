...
export declare type USDTieredSTOFactoryEventArgs_3_1_0 = USDTieredSTOFactoryLogicContractSetEventArgs_3_1_0 | USDTieredSTOFactoryModuleUpgradedEventArgs_3_1_0 | USDTieredSTOFactoryOwnershipTransferredEventArgs_3_1_0 | USDTieredSTOFactoryChangeSetupCostEventArgs_3_1_0 | USDTieredSTOFactoryChangeCostTypeEventArgs_3_1_0 | USDTieredSTOFactoryGenerateModuleFromFactoryEventArgs_3_1_0 | USDTieredSTOFactoryChangeSTVersionBoundEventArgs_3_1_0;
export declare enum USDTieredSTOFactoryEvents_3_1_0 {
...
export declare class USDTieredSTOFactoryContract_3_1_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>, _setupCost: BigNumber, _logicContract: string, _polymathRegistry: string, _isCostInPoly: boolean): Promise<USDTieredSTOFactoryContract_3_1_0>;
    /**
