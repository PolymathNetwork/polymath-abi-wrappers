...
export declare type ModuleRegistryEventArgs_3_1_0 = ModuleRegistryPauseEventArgs_3_1_0 | ModuleRegistryUnpauseEventArgs_3_1_0 | ModuleRegistryModuleUsedEventArgs_3_1_0 | ModuleRegistryModuleRegisteredEventArgs_3_1_0 | ModuleRegistryModuleVerifiedEventArgs_3_1_0 | ModuleRegistryModuleUnverifiedEventArgs_3_1_0 | ModuleRegistryModuleRemovedEventArgs_3_1_0 | ModuleRegistryOwnershipTransferredEventArgs_3_1_0;
export declare enum ModuleRegistryEvents_3_1_0 {
    Pause = "Pause",
    Unpause = "Unpause",
...
export declare class ModuleRegistryContract_3_1_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<ModuleRegistryContract_3_1_0>;
    /**
