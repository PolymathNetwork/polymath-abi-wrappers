...
export declare type CountTransferManagerEventArgs_3_1_0 = CountTransferManagerModifyHolderCountEventArgs_3_1_0 | CountTransferManagerPauseEventArgs_3_1_0 | CountTransferManagerUnpauseEventArgs_3_1_0;
export declare enum CountTransferManagerEvents_3_1_0 {
...
export declare class CountTransferManagerContract_3_1_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>, _securityToken: string, _polyToken: string): Promise<CountTransferManagerContract_3_1_0>;
    /**
