...
export declare type VestingEscrowWalletEventArgs_3_1_0 = VestingEscrowWalletAddScheduleEventArgs_3_1_0 | VestingEscrowWalletModifyScheduleEventArgs_3_1_0 | VestingEscrowWalletRevokeAllSchedulesEventArgs_3_1_0 | VestingEscrowWalletRevokeScheduleEventArgs_3_1_0 | VestingEscrowWalletDepositTokensEventArgs_3_1_0 | VestingEscrowWalletSendToTreasuryEventArgs_3_1_0 | VestingEscrowWalletSendTokensEventArgs_3_1_0 | VestingEscrowWalletAddTemplateEventArgs_3_1_0 | VestingEscrowWalletRemoveTemplateEventArgs_3_1_0 | VestingEscrowWalletTreasuryWalletChangedEventArgs_3_1_0 | VestingEscrowWalletPauseEventArgs_3_1_0 | VestingEscrowWalletUnpauseEventArgs_3_1_0;
export declare enum VestingEscrowWalletEvents_3_1_0 {
...
export declare class VestingEscrowWalletContract_3_1_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>, _securityToken: string, _polyAddress: string): Promise<VestingEscrowWalletContract_3_1_0>;
    /**
