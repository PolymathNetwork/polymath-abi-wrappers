...
export declare class USDTieredSTOContract extends BaseContract {
    ...
    modifyAddresses: {
        sendTransactionAsync(_wallet: string, _reserveWallet: string, _usdTokens: string[], txData?: Partial<TxData>): Promise<string>;
    ...
    buyWithUSD: {
        sendTransactionAsync(_beneficiary: string, _investedSC: BigNumber, _usdToken: string, txData?: Partial<TxData>): Promise<string>;
    ...
    buyWithUSDRateLimited: {
        sendTransactionAsync(_beneficiary: string, _investedSC: BigNumber, _minTokens: BigNumber, _usdToken: string, txData?: Partial<TxData>): Promise<string>;
