...
export declare class USDTieredSTOContract extends BaseContract {
    ...
    configure: {
        sendTransactionAsync(_startTime: BigNumber, _endTime: BigNumber, _ratePerTier: BigNumber[], _ratePerTierDiscountPoly: BigNumber[], _tokensPerTierTotal: BigNumber[], _tokensPerTierDiscountPoly: BigNumber[], _nonAccreditedLimitUSD: BigNumber, _minimumInvestmentUSD: BigNumber, _fundRaiseTypes: (number | BigNumber)[], _wallet: string, _reserveWallet: string, _usdToken: string, txData?: Partial<TxData>): Promise<string>;
        estimateGasAsync(_startTime: BigNumber, _endTime: BigNumber, _ratePerTier: BigNumber[], _ratePerTierDiscountPoly: BigNumber[], _tokensPerTierTotal: BigNumber[], _tokensPerTierDiscountPoly: BigNumber[], _nonAccreditedLimitUSD: BigNumber, _minimumInvestmentUSD: BigNumber, _fundRaiseTypes: (number | BigNumber)[], _wallet: string, _reserveWallet: string, _usdToken: string, txData?: Partial<TxData>): Promise<number>;
        getABIEncodedTransactionData(_startTime: BigNumber, _endTime: BigNumber, _ratePerTier: BigNumber[], _ratePerTierDiscountPoly: BigNumber[], _tokensPerTierTotal: BigNumber[], _tokensPerTierDiscountPoly: BigNumber[], _nonAccreditedLimitUSD: BigNumber, _minimumInvestmentUSD: BigNumber, _fundRaiseTypes: (number | BigNumber)[], _wallet: string, _reserveWallet: string, _usdToken: string): string;
        callAsync(_startTime: BigNumber, _endTime: BigNumber, _ratePerTier: BigNumber[], _ratePerTierDiscountPoly: BigNumber[], _tokensPerTierTotal: BigNumber[], _tokensPerTierDiscountPoly: BigNumber[], _nonAccreditedLimitUSD: BigNumber, _minimumInvestmentUSD: BigNumber, _fundRaiseTypes: (number | BigNumber)[], _wallet: string, _reserveWallet: string, _usdToken: string, callData?: Partial<CallData>, defaultBlock?: number | BlockParamLiteral | undefined): Promise<void>;
    };
    modifyFunding: {
        sendTransactionAsync(_fundRaiseTypes: (number | BigNumber)[], txData?: Partial<TxData>): Promise<string>;
    ...
    modifyLimits: {
        sendTransactionAsync(_nonAccreditedLimitUSD: BigNumber, _minimumInvestmentUSD: BigNumber, txData?: Partial<TxData>): Promise<string>;
    ...
    modifyTiers: {
        sendTransactionAsync(_ratePerTier: BigNumber[], _ratePerTierDiscountPoly: BigNumber[], _tokensPerTierTotal: BigNumber[], _tokensPerTierDiscountPoly: BigNumber[], txData?: Partial<TxData>): Promise<string>;
    ...
    modifyTimes: {
        sendTransactionAsync(_startTime: BigNumber, _endTime: BigNumber, txData?: Partial<TxData>): Promise<string>;
    ...
    modifyAddresses: {
        sendTransactionAsync(_wallet: string, _reserveWallet: string, _usdToken: string, txData?: Partial<TxData>): Promise<string>;
        estimateGasAsync(_wallet: string, _reserveWallet: string, _usdToken: string, txData?: Partial<TxData>): Promise<number>;
        getABIEncodedTransactionData(_wallet: string, _reserveWallet: string, _usdToken: string): string;
        callAsync(_wallet: string, _reserveWallet: string, _usdToken: string, callData?: Partial<CallData>, defaultBlock?: number | BlockParamLiteral | undefined): Promise<void>;
    };
    finalize: {
        sendTransactionAsync(txData?: Partial<TxData>): Promise<string>;
        estimateGasAsync(txData?: Partial<TxData>): Promise<number>;
    ...
    changeAccredited: {
        sendTransactionAsync(_investors: string[], _accredited: boolean[], txData?: Partial<TxData>): Promise<string>;
    ...
    changeNonAccreditedLimit: {
        sendTransactionAsync(_investors: string[], _nonAccreditedLimit: BigNumber[], txData?: Partial<TxData>): Promise<string>;
    ...
    changeAllowBeneficialInvestments: {
        sendTransactionAsync(_allowBeneficialInvestments: boolean, txData?: Partial<TxData>): Promise<string>;
    ...
    buyWithETH: {
        sendTransactionAsync(_beneficiary: string, txData?: Partial<TxDataPayable>): Promise<string>;
    ...
    buyWithPOLY: {
        sendTransactionAsync(_beneficiary: string, _investedPOLY: BigNumber, txData?: Partial<TxData>): Promise<string>;
    ...
    buyWithUSD: {
        sendTransactionAsync(_beneficiary: string, _investedDAI: BigNumber, txData?: Partial<TxData>): Promise<string>;
        estimateGasAsync(_beneficiary: string, _investedDAI: BigNumber, txData?: Partial<TxData>): Promise<number>;
        getABIEncodedTransactionData(_beneficiary: string, _investedDAI: BigNumber): string;
        callAsync(_beneficiary: string, _investedDAI: BigNumber, callData?: Partial<CallData>, defaultBlock?: number | BlockParamLiteral | undefined): Promise<void>;
    };
    buyWithETHRateLimited: {
        sendTransactionAsync(_beneficiary: string, _minTokens: BigNumber, txData?: Partial<TxDataPayable>): Promise<string>;
    ...
    buyWithPOLYRateLimited: {
        sendTransactionAsync(_beneficiary: string, _investedPOLY: BigNumber, _minTokens: BigNumber, txData?: Partial<TxData>): Promise<string>;
    ...
    buyWithUSDRateLimited: {
        sendTransactionAsync(_beneficiary: string, _investedDAI: BigNumber, _minTokens: BigNumber, txData?: Partial<TxData>): Promise<string>;
        estimateGasAsync(_beneficiary: string, _investedDAI: BigNumber, _minTokens: BigNumber, txData?: Partial<TxData>): Promise<number>;
        getABIEncodedTransactionData(_beneficiary: string, _investedDAI: BigNumber, _minTokens: BigNumber): string;
        callAsync(_beneficiary: string, _investedDAI: BigNumber, _minTokens: BigNumber, callData?: Partial<CallData>, defaultBlock?: number | BlockParamLiteral | undefined): Promise<void>;
    };
    buyTokensView: {
