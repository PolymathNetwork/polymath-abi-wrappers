...
(function (OwnableEvents) {
    OwnableEvents["OwnershipRenounced"] = "OwnershipRenounced";
...
var OwnableContract = /** @class */ (function (_super) {
    ...
    function OwnableContract(abi, address, provider, txDefaults, defaultEstimateGasFactor) {
        var _this = _super.call(this, 'Ownable', abi, address, provider, txDefaults) || this;
        _this.owner = {
