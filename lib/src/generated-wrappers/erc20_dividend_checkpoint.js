...
var ERC20DividendCheckpointContract = /** @class */ (function (_super) {
    ...
    function ERC20DividendCheckpointContract(abi, address, provider, txDefaults) {
        ...
        _this.createDividend = {
            sendTransactionAsync: function (_maturity, _expiry, _token, _amount, _name, txData, factor) {
                if (txData === void 0) { txData = {}; }
                if (factor === void 0) { factor = 1.2; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.createDividend.estimateGasAsync.bind(self, _maturity, _expiry, _token, _amount, _name, factor))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
        ...
        _this.createDividendWithCheckpoint = {
            sendTransactionAsync: function (_maturity, _expiry, _token, _amount, _checkpointId, _name, txData, factor) {
                if (txData === void 0) { txData = {}; }
                if (factor === void 0) { factor = 1.2; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.createDividendWithCheckpoint.estimateGasAsync.bind(self, _maturity, _expiry, _token, _amount, _checkpointId, _name, factor))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
        ...
        _this.createDividendWithExclusions = {
            sendTransactionAsync: function (_maturity, _expiry, _token, _amount, _excluded, _name, txData, factor) {
                if (txData === void 0) { txData = {}; }
                if (factor === void 0) { factor = 1.2; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.createDividendWithExclusions.estimateGasAsync.bind(self, _maturity, _expiry, _token, _amount, _excluded, _name, factor))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
        ...
        _this.createDividendWithCheckpointAndExclusions = {
            sendTransactionAsync: function (_maturity, _expiry, _token, _amount, _checkpointId, _excluded, _name, txData, factor) {
                if (txData === void 0) { txData = {}; }
                if (factor === void 0) { factor = 1.2; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, txDataWithDefaults, txHash, receipt;
