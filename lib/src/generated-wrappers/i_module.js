...
var IModuleContract = /** @class */ (function (_super) {
    __extends(IModuleContract, _super);
    function IModuleContract(abi, address, provider, txDefaults) {
        var _this = _super.call(this, 'IModule', abi, address, provider, txDefaults) || this;
    ...
    return IModuleContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.IModuleContract = IModuleContract;
// tslint:enable:no-unbound-method
//# sourceMappingURL=i_module.js.map