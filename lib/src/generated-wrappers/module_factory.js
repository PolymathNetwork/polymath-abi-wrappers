...
var ModuleFactoryEvents;
(function (ModuleFactoryEvents) {
    ModuleFactoryEvents["OwnershipRenounced"] = "OwnershipRenounced";
    ModuleFactoryEvents["OwnershipTransferred"] = "OwnershipTransferred";
    ModuleFactoryEvents["ChangeFactorySetupFee"] = "ChangeFactorySetupFee";
    ModuleFactoryEvents["ChangeFactoryUsageFee"] = "ChangeFactoryUsageFee";
    ModuleFactoryEvents["ChangeFactorySubscriptionFee"] = "ChangeFactorySubscriptionFee";
    ModuleFactoryEvents["GenerateModuleFromFactory"] = "GenerateModuleFromFactory";
    ModuleFactoryEvents["ChangeSTVersionBound"] = "ChangeSTVersionBound";
})(ModuleFactoryEvents = exports.ModuleFactoryEvents || (exports.ModuleFactoryEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var ModuleFactoryContract = /** @class */ (function (_super) {
    __extends(ModuleFactoryContract, _super);
    function ModuleFactoryContract(abi, address, provider, txDefaults) {
        var _this = _super.call(this, 'ModuleFactory', abi, address, provider, txDefaults) || this;
        _this.deploy = {
    ...
    return ModuleFactoryContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.ModuleFactoryContract = ModuleFactoryContract;
