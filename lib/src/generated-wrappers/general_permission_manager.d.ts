...
export declare class GeneralPermissionManagerContract extends BaseContract {
    ...
    addDelegate: {
        sendTransactionAsync(_delegate: string, _details: string, txData?: Partial<TxData>): Promise<string>;
    ...
    deleteDelegate: {
        sendTransactionAsync(_delegate: string, txData?: Partial<TxData>): Promise<string>;
    ...
    changePermission: {
        sendTransactionAsync(_delegate: string, _module: string, _perm: string, _valid: boolean, txData?: Partial<TxData>): Promise<string>;
    ...
    changePermissionMulti: {
        sendTransactionAsync(_delegate: string, _modules: string[], _perms: string[], _valids: boolean[], txData?: Partial<TxData>): Promise<string>;
