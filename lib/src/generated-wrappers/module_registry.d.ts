...
export declare class ModuleRegistryContract extends BaseContract {
    ...
    initialize: {
        sendTransactionAsync(_polymathRegistry: string, _owner: string, txData?: Partial<TxDataPayable>): Promise<string>;
    ...
    useModule: {
        sendTransactionAsync(_moduleFactory: string, txData?: Partial<TxData>): Promise<string>;
    ...
    verifyModule: {
        sendTransactionAsync(_moduleFactory: string, _verified: boolean, txData?: Partial<TxData>): Promise<string>;
