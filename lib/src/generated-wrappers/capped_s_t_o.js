...
var CappedSTOContract = /** @class */ (function (_super) {
    ...
    function CappedSTOContract(abi, address, provider, txDefaults) {
        ...
        _this.configure = {
            sendTransactionAsync: function (_startTime, _endTime, _cap, _rate, _fundRaiseTypes, _fundsReceiver, txData, factor) {
                if (txData === void 0) { txData = {}; }
                if (factor === void 0) { factor = 1.2; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.configure.estimateGasAsync.bind(self, _startTime, _endTime, _cap, _rate, _fundRaiseTypes, _fundsReceiver, factor))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.buyTokens.estimateGasAsync.bind(self, _beneficiary, factor))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
        ...
        _this.buyTokensWithPoly = {
            sendTransactionAsync: function (_investedPOLY, txData, factor) {
                if (txData === void 0) { txData = {}; }
                if (factor === void 0) { factor = 1.2; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.buyTokensWithPoly.estimateGasAsync.bind(self, _investedPOLY, factor))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
