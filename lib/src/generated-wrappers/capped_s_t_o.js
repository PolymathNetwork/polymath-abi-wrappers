...
var CappedSTOEvents;
(function (CappedSTOEvents) {
    CappedSTOEvents["TokenPurchase"] = "TokenPurchase";
    CappedSTOEvents["SetAllowBeneficialInvestments"] = "SetAllowBeneficialInvestments";
    CappedSTOEvents["SetFundRaiseTypes"] = "SetFundRaiseTypes";
    CappedSTOEvents["Pause"] = "Pause";
    CappedSTOEvents["Unpause"] = "Unpause";
})(CappedSTOEvents = exports.CappedSTOEvents || (exports.CappedSTOEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var CappedSTOContract = /** @class */ (function (_super) {
    __extends(CappedSTOContract, _super);
    function CappedSTOContract(abi, address, provider, txDefaults, defaultEstimateGasFactor) {
        var _this = _super.call(this, 'CappedSTO', abi, address, provider, txDefaults) || this;
        _this.rate = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.rate;
                            ...
                            case 2:
                                ...
                                outputAbi = _.find(self.abi, { name: 'rate' }).outputs;
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                functionSignature = 'cap()';
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [], base_contract_1.BaseContract._bigNumberToString.bind(self));
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, []);
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.cap;
                                encodedData = ethersFunction.encode([]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _a.sent();
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'cap' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                                return [2 /*return*/, resultArray[0]];
                        }
        ...
        _this.configure = {
            sendTransactionAsync: function (_startTime, _endTime, _cap, _rate, _fundRaiseTypes, _fundsReceiver, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('configure(uint256,uint256,uint256,uint256,uint8[],address)').inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_startTime,
                                    ...
                                    _fundRaiseTypes,
                                    _fundsReceiver
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 6), _startTime = _a[0], _endTime = _a[1], _cap = _a[2], _rate = _a[3], _fundRaiseTypes = _a[4], _fundsReceiver = _a[5];
                                ...
                                encodedData = self._lookupEthersInterface('configure(uint256,uint256,uint256,uint256,uint8[],address)').functions.configure.encode([_startTime,
                                    _endTime,
                                    _cap,
                                    _rate,
                                    _fundRaiseTypes,
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.configure.estimateGasAsync.bind(self, _startTime, _endTime, _cap, _rate, _fundRaiseTypes, _fundsReceiver, estimateGasFactor))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
            ...
            estimateGasAsync: function (_startTime, _endTime, _cap, _rate, _fundRaiseTypes, _fundsReceiver, factor, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, txDataWithDefaults, gas, networkGasLimit, _factor, _safetyGasEstimation;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_startTime,
                                    ...
                                    _fundRaiseTypes,
                                    _fundsReceiver
                                ], base_contract_1.BaseContract._bigNumberToString), 6), _startTime = _a[0], _endTime = _a[1], _cap = _a[2], _rate = _a[3], _fundRaiseTypes = _a[4], _fundsReceiver = _a[5];
                                encodedData = self._lookupEthersInterface('configure(uint256,uint256,uint256,uint256,uint8[],address)').functions.configure.encode([_startTime,
                                    _endTime,
                                    _cap,
                                    _rate,
            ...
            getABIEncodedTransactionData: function (_startTime, _endTime, _cap, _rate, _fundRaiseTypes, _fundsReceiver) {
                var _a;
                var self = this;
                var inputAbi = self._lookupAbi('configure(uint256,uint256,uint256,uint256,uint8[],address)').inputs;
                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_startTime,
                    _endTime,
                    _cap,
                    _rate,
                ...
                var abiEncodedTransactionData = self._lookupEthersInterface('configure(uint256,uint256,uint256,uint256,uint8[],address)').functions.configure.encode([_startTime,
                    _endTime,
                    _cap,
                    _rate,
                    _fundRaiseTypes,
            ...
            callAsync: function (_startTime, _endTime, _cap, _rate, _fundRaiseTypes, _fundsReceiver, callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, functionSignature, inputAbi, ethersFunction, encodedData, callDataWithDefaults, rawCallResult, resultArray, outputAbi;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                functionSignature = 'configure(uint256,uint256,uint256,uint256,uint8[],address)';
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_startTime,
                                    _endTime,
                                    _cap,
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.changeAllowBeneficialInvestments.estimateGasAsync.bind(self, _allowBeneficialInvestments, estimateGasFactor))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
        ...
        _this.buyTokens = {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('buyTokens(address)').inputs;
                                ...
                                encodedData = self._lookupEthersInterface('buyTokens(address)').functions.buyTokens.encode([_beneficiary
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.buyTokens.estimateGasAsync.bind(self, _beneficiary, estimateGasFactor))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
            ...
            getABIEncodedTransactionData: function (_beneficiary) {
                var _a;
                var self = this;
                var inputAbi = self._lookupAbi('buyTokens(address)').inputs;
                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_beneficiary
                ], base_contract_1.BaseContract._bigNumberToString), 1), _beneficiary = _a[0];
                var abiEncodedTransactionData = self._lookupEthersInterface('buyTokens(address)').functions.buyTokens.encode([_beneficiary
                ]);
                return abiEncodedTransactionData;
            },
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                functionSignature = 'buyTokens(address)';
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_beneficiary
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 1), _beneficiary = _a[0];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [_beneficiary
                                ]);
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.buyTokens;
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'buyTokens' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                                return [2 /*return*/, resultArray];
                        }
        ...
        _this.buyTokensWithPoly = {
            sendTransactionAsync: function (_investedPOLY, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('buyTokensWithPoly(uint256)').inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_investedPOLY
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 1), _investedPOLY = _a[0];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [_investedPOLY
                                ]);
                                encodedData = self._lookupEthersInterface('buyTokensWithPoly(uint256)').functions.buyTokensWithPoly.encode([_investedPOLY
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.buyTokensWithPoly.estimateGasAsync.bind(self, _investedPOLY, estimateGasFactor))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
            ...
            estimateGasAsync: function (_investedPOLY, factor, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, txDataWithDefaults, gas, networkGasLimit, _factor, _safetyGasEstimation;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                inputAbi = self._lookupAbi('buyTokensWithPoly(uint256)').inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_investedPOLY
                                ], base_contract_1.BaseContract._bigNumberToString), 1), _investedPOLY = _a[0];
                                encodedData = self._lookupEthersInterface('buyTokensWithPoly(uint256)').functions.buyTokensWithPoly.encode([_investedPOLY
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
            ...
            getABIEncodedTransactionData: function (_investedPOLY) {
                var _a;
                var self = this;
                var inputAbi = self._lookupAbi('buyTokensWithPoly(uint256)').inputs;
                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_investedPOLY
                ], base_contract_1.BaseContract._bigNumberToString), 1), _investedPOLY = _a[0];
                var abiEncodedTransactionData = self._lookupEthersInterface('buyTokensWithPoly(uint256)').functions.buyTokensWithPoly.encode([_investedPOLY
                ]);
                return abiEncodedTransactionData;
            },
            callAsync: function (_investedPOLY, callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, functionSignature, inputAbi, ethersFunction, encodedData, callDataWithDefaults, rawCallResult, resultArray, outputAbi;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                functionSignature = 'buyTokensWithPoly(uint256)';
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_investedPOLY
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 1), _investedPOLY = _a[0];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [_investedPOLY
                                ]);
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.buyTokensWithPoly;
                                encodedData = ethersFunction.encode([_investedPOLY
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
                                callDataWithDefaults = _b.sent();
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'buyTokensWithPoly' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                                return [2 /*return*/, resultArray];
                        }
    ...
    return CappedSTOContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.CappedSTOContract = CappedSTOContract;
// tslint:enable:no-unbound-method
//# sourceMappingURL=capped_s_t_o.js.map