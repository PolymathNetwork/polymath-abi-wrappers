...
export declare class SecurityTokenRegistryContract extends BaseContract {
    ...
    initialize: {
        sendTransactionAsync(_polymathRegistry: string, _STFactory: string, _stLaunchFee: BigNumber, _tickerRegFee: BigNumber, _polyToken: string, _owner: string, txData?: Partial<TxDataPayable>, factor?: number): Promise<PolyResponse>;
        estimateGasAsync(_polymathRegistry: string, _STFactory: string, _stLaunchFee: BigNumber, _tickerRegFee: BigNumber, _polyToken: string, _owner: string, factor: number, txData?: Partial<TxData>): Promise<number>;
    ...
    registerTicker: {
        sendTransactionAsync(_owner: string, _ticker: string, _tokenName: string, txData?: Partial<TxData>, factor?: number): Promise<PolyResponse>;
        estimateGasAsync(_owner: string, _ticker: string, _tokenName: string, factor: number, txData?: Partial<TxData>): Promise<number>;
    ...
    modifyTicker: {
        sendTransactionAsync(_owner: string, _ticker: string, _tokenName: string, _registrationDate: BigNumber, _expiryDate: BigNumber, _status: boolean, txData?: Partial<TxData>, factor?: number): Promise<PolyResponse>;
        estimateGasAsync(_owner: string, _ticker: string, _tokenName: string, _registrationDate: BigNumber, _expiryDate: BigNumber, _status: boolean, factor: number, txData?: Partial<TxData>): Promise<number>;
    ...
    removeTicker: {
        sendTransactionAsync(_ticker: string, txData?: Partial<TxData>, factor?: number): Promise<PolyResponse>;
        estimateGasAsync(_ticker: string, factor: number, txData?: Partial<TxData>): Promise<number>;
    ...
    transferTickerOwnership: {
        sendTransactionAsync(_newOwner: string, _ticker: string, txData?: Partial<TxData>, factor?: number): Promise<PolyResponse>;
        estimateGasAsync(_newOwner: string, _ticker: string, factor: number, txData?: Partial<TxData>): Promise<number>;
    ...
    changeExpiryLimit: {
        sendTransactionAsync(_newExpiry: BigNumber, txData?: Partial<TxData>, factor?: number): Promise<PolyResponse>;
        estimateGasAsync(_newExpiry: BigNumber, factor: number, txData?: Partial<TxData>): Promise<number>;
    ...
    generateSecurityToken: {
        sendTransactionAsync(_name: string, _ticker: string, _tokenDetails: string, _divisible: boolean, txData?: Partial<TxData>, factor?: number): Promise<PolyResponse>;
        estimateGasAsync(_name: string, _ticker: string, _tokenDetails: string, _divisible: boolean, factor: number, txData?: Partial<TxData>): Promise<number>;
    ...
    modifySecurityToken: {
        sendTransactionAsync(_name: string, _ticker: string, _owner: string, _securityToken: string, _tokenDetails: string, _deployedAt: BigNumber, txData?: Partial<TxData>, factor?: number): Promise<PolyResponse>;
        estimateGasAsync(_name: string, _ticker: string, _owner: string, _securityToken: string, _tokenDetails: string, _deployedAt: BigNumber, factor: number, txData?: Partial<TxData>): Promise<number>;
    ...
    changeTickerRegistrationFee: {
        sendTransactionAsync(_tickerRegFee: BigNumber, txData?: Partial<TxData>, factor?: number): Promise<PolyResponse>;
        estimateGasAsync(_tickerRegFee: BigNumber, factor: number, txData?: Partial<TxData>): Promise<number>;
    ...
    changeSecurityLaunchFee: {
        sendTransactionAsync(_stLaunchFee: BigNumber, txData?: Partial<TxData>, factor?: number): Promise<PolyResponse>;
        estimateGasAsync(_stLaunchFee: BigNumber, factor: number, txData?: Partial<TxData>): Promise<number>;
    ...
    setProtocolVersion: {
        sendTransactionAsync(_STFactoryAddress: string, _major: number | BigNumber, _minor: number | BigNumber, _patch: number | BigNumber, txData?: Partial<TxData>, factor?: number): Promise<PolyResponse>;
        estimateGasAsync(_STFactoryAddress: string, _major: number | BigNumber, _minor: number | BigNumber, _patch: number | BigNumber, factor: number, txData?: Partial<TxData>): Promise<number>;
    ...
    updatePolyTokenAddress: {
        sendTransactionAsync(_newAddress: string, txData?: Partial<TxData>, factor?: number): Promise<PolyResponse>;
        estimateGasAsync(_newAddress: string, factor: number, txData?: Partial<TxData>): Promise<number>;
