...
export declare class SecurityTokenRegistryContract extends BaseContract {
    ...
    initialize: {
        sendTransactionAsync(_polymathRegistry: string, _STFactory: string, _stLaunchFee: BigNumber, _tickerRegFee: BigNumber, _polyToken: string, _owner: string, txData?: Partial<TxDataPayable>): Promise<PolyResponse>;
    ...
    registerTicker: {
        sendTransactionAsync(_owner: string, _ticker: string, _tokenName: string, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    modifyTicker: {
        sendTransactionAsync(_owner: string, _ticker: string, _tokenName: string, _registrationDate: BigNumber, _expiryDate: BigNumber, _status: boolean, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    removeTicker: {
        sendTransactionAsync(_ticker: string, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    transferTickerOwnership: {
        sendTransactionAsync(_newOwner: string, _ticker: string, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    changeExpiryLimit: {
        sendTransactionAsync(_newExpiry: BigNumber, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    generateSecurityToken: {
        sendTransactionAsync(_name: string, _ticker: string, _tokenDetails: string, _divisible: boolean, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    modifySecurityToken: {
        sendTransactionAsync(_name: string, _ticker: string, _owner: string, _securityToken: string, _tokenDetails: string, _deployedAt: BigNumber, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    changeTickerRegistrationFee: {
        sendTransactionAsync(_tickerRegFee: BigNumber, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    changeSecurityLaunchFee: {
        sendTransactionAsync(_stLaunchFee: BigNumber, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    setProtocolVersion: {
        sendTransactionAsync(_STFactoryAddress: string, _major: number | BigNumber, _minor: number | BigNumber, _patch: number | BigNumber, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    updatePolyTokenAddress: {
        sendTransactionAsync(_newAddress: string, txData?: Partial<TxData>): Promise<PolyResponse>;
