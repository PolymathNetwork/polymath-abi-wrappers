...
var FeatureRegistryEvents;
(function (FeatureRegistryEvents) {
    FeatureRegistryEvents["ChangeFeatureStatus"] = "ChangeFeatureStatus";
    FeatureRegistryEvents["OwnershipRenounced"] = "OwnershipRenounced";
    FeatureRegistryEvents["OwnershipTransferred"] = "OwnershipTransferred";
})(FeatureRegistryEvents = exports.FeatureRegistryEvents || (exports.FeatureRegistryEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var FeatureRegistryContract = /** @class */ (function (_super) {
    __extends(FeatureRegistryContract, _super);
    function FeatureRegistryContract(abi, address, provider, txDefaults, defaultEstimateGasFactor) {
        var _this = _super.call(this, 'FeatureRegistry', abi, address, provider, txDefaults) || this;
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                functionSignature = 'featureStatus(bytes32)';
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.featureStatus;
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'featureStatus' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                                return [2 /*return*/, resultArray[0]];
                        }
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                functionSignature = 'getFeatureStatus(string)';
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.getFeatureStatus;
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'getFeatureStatus' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                                return [2 /*return*/, resultArray[0]];
                        }
        ...
        _this.setFeatureStatus = {
            sendTransactionAsync: function (_nameKey, _newStatus, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('setFeatureStatus(string,bool)').inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_nameKey,
                                    _newStatus
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 2), _nameKey = _a[0], _newStatus = _a[1];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [_nameKey,
                                    _newStatus
                                ]);
                                encodedData = self._lookupEthersInterface('setFeatureStatus(string,bool)').functions.setFeatureStatus.encode([_nameKey,
                                    _newStatus
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.setFeatureStatus.estimateGasAsync.bind(self, _nameKey, _newStatus, estimateGasFactor))];
                            case 1:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 2:
            ...
            estimateGasAsync: function (_nameKey, _newStatus, factor, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, txDataWithDefaults, gas, networkGasLimit, _factor, _safetyGasEstimation;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_nameKey,
                                    _newStatus
                                ], base_contract_1.BaseContract._bigNumberToString), 2), _nameKey = _a[0], _newStatus = _a[1];
                                encodedData = self._lookupEthersInterface('setFeatureStatus(string,bool)').functions.setFeatureStatus.encode([_nameKey,
                                    _newStatus
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
            ...
            getABIEncodedTransactionData: function (_nameKey, _newStatus) {
                var _a;
                var self = this;
                var inputAbi = self._lookupAbi('setFeatureStatus(string,bool)').inputs;
                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_nameKey,
                    _newStatus
                ], base_contract_1.BaseContract._bigNumberToString), 2), _nameKey = _a[0], _newStatus = _a[1];
                var abiEncodedTransactionData = self._lookupEthersInterface('setFeatureStatus(string,bool)').functions.setFeatureStatus.encode([_nameKey,
                    _newStatus
                ]);
                return abiEncodedTransactionData;
            },
            callAsync: function (_nameKey, _newStatus, callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, functionSignature, inputAbi, ethersFunction, encodedData, callDataWithDefaults, rawCallResult, resultArray, outputAbi;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                functionSignature = 'setFeatureStatus(string,bool)';
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_nameKey,
                                    _newStatus
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 2), _nameKey = _a[0], _newStatus = _a[1];
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.setFeatureStatus;
                                encodedData = ethersFunction.encode([_nameKey,
                                    _newStatus
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'setFeatureStatus' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                                return [2 /*return*/, resultArray];
                        }
    ...
    return FeatureRegistryContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.FeatureRegistryContract = FeatureRegistryContract;
// tslint:enable:no-unbound-method
//# sourceMappingURL=feature_registry.js.map