...
var ManualApprovalTransferManagerContract = /** @class */ (function (_super) {
    ...
    function ManualApprovalTransferManagerContract(abi, address, provider, txDefaults, defaultEstimateGasFactor) {
        ...
        _this.modifyManualApproval = {
            sendTransactionAsync: function (_from, _to, _expiryTime, _changeInAllowance, _description, _increase, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('modifyManualApproval(address,address,uint256,uint256,bytes32,bool)').inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_from,
                                    _to,
                                    _expiryTime,
                                    _changeInAllowance,
                                    _description,
                                    _increase
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 6), _from = _a[0], _to = _a[1], _expiryTime = _a[2], _changeInAllowance = _a[3], _description = _a[4], _increase = _a[5];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [_from,
                                    _to,
                                    _expiryTime,
                                    _changeInAllowance,
                                ...
                                encodedData = self._lookupEthersInterface('modifyManualApproval(address,address,uint256,uint256,bytes32,bool)').functions.modifyManualApproval.encode([_from,
                                    _to,
                                    _expiryTime,
                                    _changeInAllowance,
                                    _description,
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), contractDefaults, self.modifyManualApproval.estimateGasAsync.bind(self, _from, _to, _expiryTime, _changeInAllowance, _description, _increase, estimateGasFactor))];
                            case 2:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 3:
            ...
            estimateGasAsync: function (_from, _to, _expiryTime, _changeInAllowance, _description, _increase, factor, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, gas, networkGasLimit, _factor, _safetyGasEstimation;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_from,
                                    ...
                                    _description,
                                    _increase
                                ], base_contract_1.BaseContract._bigNumberToString), 6), _from = _a[0], _to = _a[1], _expiryTime = _a[2], _changeInAllowance = _a[3], _description = _a[4], _increase = _a[5];
                                encodedData = self._lookupEthersInterface('modifyManualApproval(address,address,uint256,uint256,bytes32,bool)').functions.modifyManualApproval.encode([_from,
                                    _to,
                                    _expiryTime,
                                    _changeInAllowance,
            ...
            getABIEncodedTransactionData: function (_from, _to, _expiryTime, _changeInAllowance, _description, _increase) {
                var _a;
                var self = this;
                var inputAbi = self._lookupAbi('modifyManualApproval(address,address,uint256,uint256,bytes32,bool)').inputs;
                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_from,
                    _to,
                    _expiryTime,
                    _changeInAllowance,
                ...
                var abiEncodedTransactionData = self._lookupEthersInterface('modifyManualApproval(address,address,uint256,uint256,bytes32,bool)').functions.modifyManualApproval.encode([_from,
                    _to,
                    _expiryTime,
                    _changeInAllowance,
                    _description,
            ...
            callAsync: function (_from, _to, _expiryTime, _changeInAllowance, _description, _increase, callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, functionSignature, inputAbi, ethersFunction, encodedData, callDataWithDefaults, rawCallResult, resultArray, outputAbi;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                functionSignature = 'modifyManualApproval(address,address,uint256,uint256,bytes32,bool)';
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_from,
                                    _to,
                                    _expiryTime,
        ...
        _this.modifyManualApprovalMulti = {
            sendTransactionAsync: function (_from, _to, _expiryTimes, _changedAllowances, _descriptions, _increase, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('modifyManualApprovalMulti(address[],address[],uint256[],uint256[],bytes32[],bool[])').inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_from,
                                    _to,
                                    _expiryTimes,
                                    _changedAllowances,
                                    _descriptions,
                                    _increase
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 6), _from = _a[0], _to = _a[1], _expiryTimes = _a[2], _changedAllowances = _a[3], _descriptions = _a[4], _increase = _a[5];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [_from,
                                    _to,
                                    _expiryTimes,
                                    _changedAllowances,
                                ...
                                encodedData = self._lookupEthersInterface('modifyManualApprovalMulti(address[],address[],uint256[],uint256[],bytes32[],bool[])').functions.modifyManualApprovalMulti.encode([_from,
                                    _to,
                                    _expiryTimes,
                                    _changedAllowances,
                                    _descriptions,
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), contractDefaults, self.modifyManualApprovalMulti.estimateGasAsync.bind(self, _from, _to, _expiryTimes, _changedAllowances, _descriptions, _increase, estimateGasFactor))];
                            case 2:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 3:
            ...
            estimateGasAsync: function (_from, _to, _expiryTimes, _changedAllowances, _descriptions, _increase, factor, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, gas, networkGasLimit, _factor, _safetyGasEstimation;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_from,
                                    ...
                                    _descriptions,
                                    _increase
                                ], base_contract_1.BaseContract._bigNumberToString), 6), _from = _a[0], _to = _a[1], _expiryTimes = _a[2], _changedAllowances = _a[3], _descriptions = _a[4], _increase = _a[5];
                                encodedData = self._lookupEthersInterface('modifyManualApprovalMulti(address[],address[],uint256[],uint256[],bytes32[],bool[])').functions.modifyManualApprovalMulti.encode([_from,
                                    _to,
                                    _expiryTimes,
                                    _changedAllowances,
            ...
            getABIEncodedTransactionData: function (_from, _to, _expiryTimes, _changedAllowances, _descriptions, _increase) {
                var _a;
                var self = this;
                var inputAbi = self._lookupAbi('modifyManualApprovalMulti(address[],address[],uint256[],uint256[],bytes32[],bool[])').inputs;
                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_from,
                    _to,
                    _expiryTimes,
                    _changedAllowances,
                ...
                var abiEncodedTransactionData = self._lookupEthersInterface('modifyManualApprovalMulti(address[],address[],uint256[],uint256[],bytes32[],bool[])').functions.modifyManualApprovalMulti.encode([_from,
                    _to,
                    _expiryTimes,
                    _changedAllowances,
                    _descriptions,
            ...
            callAsync: function (_from, _to, _expiryTimes, _changedAllowances, _descriptions, _increase, callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, functionSignature, inputAbi, ethersFunction, encodedData, callDataWithDefaults, rawCallResult, resultArray, outputAbi;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                functionSignature = 'modifyManualApprovalMulti(address[],address[],uint256[],uint256[],bytes32[],bool[])';
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_from,
                                    _to,
                                    _expiryTimes,
