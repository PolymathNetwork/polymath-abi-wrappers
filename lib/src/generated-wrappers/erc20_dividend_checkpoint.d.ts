...
export declare class ERC20DividendCheckpointContract extends BaseContract {
    setWithholdingFixed: {
        sendTransactionAsync(_investors: string[], _withholding: BigNumber, txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
    ...
    pullDividendPayment: {
        sendTransactionAsync(_dividendIndex: BigNumber, txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
    ...
    pushDividendPaymentToAddresses: {
        sendTransactionAsync(_dividendIndex: BigNumber, _payees: string[], txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
    ...
    setDefaultExcluded: {
        sendTransactionAsync(_excluded: string[], txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
    ...
    pushDividendPayment: {
        sendTransactionAsync(_dividendIndex: BigNumber, _start: BigNumber, _iterations: BigNumber, txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
    ...
    createDividend: {
        sendTransactionAsync(_maturity: BigNumber, _expiry: BigNumber, _token: string, _amount: BigNumber, _name: string, txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
        estimateGasAsync(_maturity: BigNumber, _expiry: BigNumber, _token: string, _amount: BigNumber, _name: string, txData?: Partial<TxData>): Promise<number>;
    ...
    createDividendWithCheckpoint: {
        sendTransactionAsync(_maturity: BigNumber, _expiry: BigNumber, _token: string, _amount: BigNumber, _checkpointId: BigNumber, _name: string, txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
        estimateGasAsync(_maturity: BigNumber, _expiry: BigNumber, _token: string, _amount: BigNumber, _checkpointId: BigNumber, _name: string, txData?: Partial<TxData>): Promise<number>;
    ...
    createDividendWithExclusions: {
        sendTransactionAsync(_maturity: BigNumber, _expiry: BigNumber, _token: string, _amount: BigNumber, _excluded: string[], _name: string, txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
        estimateGasAsync(_maturity: BigNumber, _expiry: BigNumber, _token: string, _amount: BigNumber, _excluded: string[], _name: string, txData?: Partial<TxData>): Promise<number>;
    ...
    createDividendWithCheckpointAndExclusions: {
        sendTransactionAsync(_maturity: BigNumber, _expiry: BigNumber, _token: string, _amount: BigNumber, _checkpointId: BigNumber, _excluded: string[], _name: string, txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
        estimateGasAsync(_maturity: BigNumber, _expiry: BigNumber, _token: string, _amount: BigNumber, _checkpointId: BigNumber, _excluded: string[], _name: string, txData?: Partial<TxData>): Promise<number>;
