...
export declare class GeneralTransferManagerContract extends BaseContract {
    ...
    changeDefaults: {
        sendTransactionAsync(_defaultFromTime: BigNumber, _defaultToTime: BigNumber, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    changeIssuanceAddress: {
        sendTransactionAsync(_issuanceAddress: string, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    changeSigningAddress: {
        sendTransactionAsync(_signingAddress: string, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    changeAllowAllTransfers: {
        sendTransactionAsync(_allowAllTransfers: boolean, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    changeAllowAllWhitelistTransfers: {
        sendTransactionAsync(_allowAllWhitelistTransfers: boolean, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    changeAllowAllWhitelistIssuances: {
        sendTransactionAsync(_allowAllWhitelistIssuances: boolean, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    changeAllowAllBurnTransfers: {
        sendTransactionAsync(_allowAllBurnTransfers: boolean, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    verifyTransfer: {
        sendTransactionAsync(_from: string, _to: string, index_2: BigNumber, index_3: string, index_4: boolean, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    modifyWhitelist: {
        sendTransactionAsync(_investor: string, _fromTime: BigNumber, _toTime: BigNumber, _expiryTime: BigNumber, _canBuyFromSTO: boolean, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    modifyWhitelistMulti: {
        sendTransactionAsync(_investors: string[], _fromTimes: BigNumber[], _toTimes: BigNumber[], _expiryTimes: BigNumber[], _canBuyFromSTO: boolean[], txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    modifyWhitelistSigned: {
        sendTransactionAsync(_investor: string, _fromTime: BigNumber, _toTime: BigNumber, _expiryTime: BigNumber, _canBuyFromSTO: boolean, _validFrom: BigNumber, _validTo: BigNumber, _nonce: BigNumber, _v: number | BigNumber, _r: string, _s: string, txData?: Partial<TxData>): Promise<PolyResponse>;
