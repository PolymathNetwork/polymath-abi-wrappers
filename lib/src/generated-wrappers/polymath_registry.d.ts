...
export declare class PolymathRegistryContract extends BaseContract {
    ...
    changeAddress: {
        sendTransactionAsync(_nameKey: string, _newAddress: string, txData?: Partial<TxData>, factor?: number): Promise<PolyResponse>;
        estimateGasAsync(_nameKey: string, _newAddress: string, factor: number, txData?: Partial<TxData>): Promise<number>;
