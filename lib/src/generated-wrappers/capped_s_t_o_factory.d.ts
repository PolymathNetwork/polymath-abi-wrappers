...
export declare type CappedSTOFactoryEventArgs = CappedSTOFactoryChangeFactorySetupFeeEventArgs | CappedSTOFactoryChangeFactoryUsageFeeEventArgs | CappedSTOFactoryChangeFactorySubscriptionFeeEventArgs | CappedSTOFactoryGenerateModuleFromFactoryEventArgs | CappedSTOFactoryChangeSTVersionBoundEventArgs | CappedSTOFactoryOwnershipRenouncedEventArgs | CappedSTOFactoryOwnershipTransferredEventArgs | CappedSTOFactoryGenerateModuleFromFactoryEventArgs;
...
export declare class CappedSTOFactoryContract extends BaseContract {
    ...
    changeTitle: {
        sendTransactionAsync(_newTitle: string, txData?: Partial<TxData>): Promise<string>;
    ...
    changeFactorySubscriptionFee: {
        sendTransactionAsync(_newSubscriptionCost: BigNumber, txData?: Partial<TxData>): Promise<string>;
    ...
    changeFactorySetupFee: {
        sendTransactionAsync(_newSetupCost: BigNumber, txData?: Partial<TxData>): Promise<string>;
    ...
    changeVersion: {
        sendTransactionAsync(_newVersion: string, txData?: Partial<TxData>): Promise<string>;
    ...
    changeName: {
        sendTransactionAsync(_newName: string, txData?: Partial<TxData>): Promise<string>;
    ...
    changeFactoryUsageFee: {
        sendTransactionAsync(_newUsageCost: BigNumber, txData?: Partial<TxData>): Promise<string>;
    ...
    changeDescription: {
        sendTransactionAsync(_newDesc: string, txData?: Partial<TxData>): Promise<string>;
    ...
    changeSTVersionBounds: {
        sendTransactionAsync(_boundType: string, _newVersion: (number | BigNumber)[], txData?: Partial<TxData>): Promise<string>;
    ...
    deploy: {
        sendTransactionAsync(_data: string, txData?: Partial<TxData>): Promise<string>;
