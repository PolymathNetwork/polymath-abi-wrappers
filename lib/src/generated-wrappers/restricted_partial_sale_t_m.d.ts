...
export declare type RestrictedPartialSaleTMEventArgs = RestrictedPartialSaleTMChangedExemptWalletListEventArgs | RestrictedPartialSaleTMPauseEventArgs | RestrictedPartialSaleTMUnpauseEventArgs;
export declare enum RestrictedPartialSaleTMEvents {
...
export declare class RestrictedPartialSaleTMContract extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>, _securityToken: string, _polyAddress: string): Promise<RestrictedPartialSaleTMContract>;
    /**
