...
var PolyTokenFaucetEvents;
(function (PolyTokenFaucetEvents) {
    PolyTokenFaucetEvents["Transfer"] = "Transfer";
    PolyTokenFaucetEvents["Approval"] = "Approval";
})(PolyTokenFaucetEvents = exports.PolyTokenFaucetEvents || (exports.PolyTokenFaucetEvents = {}));
/* istanbul ignore next */
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var PolyTokenFaucetContract = /** @class */ (function (_super) {
    __extends(PolyTokenFaucetContract, _super);
    function PolyTokenFaucetContract(abi, address, provider, txDefaults, defaultEstimateGasFactor) {
        var _this = _super.call(this, 'PolyTokenFaucet', abi, address, provider, txDefaults) || this;
        _this.name = {
        ...
        _this.getTokens = {
            sendTransactionAsync: function (_amount, _recipient, txData, estimateGasFactor) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                inputAbi = self._lookupAbi('getTokens(uint256,address)').inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_amount,
                                    _recipient
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 2), _amount = _a[0], _recipient = _a[1];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [_amount,
                                    _recipient
                                ]);
                                encodedData = self._lookupEthersInterface('getTokens(uint256,address)').functions.getTokens.encode([_amount,
                                    _recipient
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), self._web3Wrapper.getContractDefaults(), self.getTokens.estimateGasAsync.bind(self, _amount, _recipient, estimateGasFactor))];
                            case 1:
            ...
            estimateGasAsync: function (_amount, _recipient, factor, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_amount,
                                    _recipient
                                ], base_contract_1.BaseContract._bigNumberToString), 2), _amount = _a[0], _recipient = _a[1];
                                encodedData = self._lookupEthersInterface('getTokens(uint256,address)').functions.getTokens.encode([_amount,
                                    _recipient
                                ]);
            ...
            getABIEncodedTransactionData: function (_amount, _recipient) {
                var _a;
                var self = this;
                var inputAbi = self._lookupAbi('getTokens(uint256,address)').inputs;
                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_amount,
                    _recipient
                ], base_contract_1.BaseContract._bigNumberToString), 2), _amount = _a[0], _recipient = _a[1];
                var abiEncodedTransactionData = self._lookupEthersInterface('getTokens(uint256,address)').functions.getTokens.encode([_amount,
                    _recipient
                ]);
                return abiEncodedTransactionData;
            },
            callAsync: function (_amount, _recipient, callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                self = this;
                                functionSignature = 'getTokens(uint256,address)';
                                inputAbi = self._lookupAbi(functionSignature).inputs;
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_amount,
                                    _recipient
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 2), _amount = _a[0], _recipient = _a[1];
                                ...
                                ethersFunction = self._lookupEthersInterface(functionSignature).functions.getTokens;
                            ...
                            case 2:
                                ...
                                base_contract_1.BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
                                resultArray = ethersFunction.decode(rawCallResult);
                                outputAbi = _.find(self.abi, { name: 'getTokens' }).outputs;
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._lowercaseAddress.bind(this));
                                resultArray = base_contract_1.BaseContract._formatABIDataItemList(outputAbi, resultArray, base_contract_1.BaseContract._bnToBigNumber.bind(this));
                                return [2 /*return*/, resultArray[0]];
                        }
    ...
    return PolyTokenFaucetContract;
}(base_contract_1.BaseContract)); // tslint:disable:max-file-line-count
exports.PolyTokenFaucetContract = PolyTokenFaucetContract;
// tslint:enable:no-unbound-method
//# sourceMappingURL=poly_token_faucet.js.map