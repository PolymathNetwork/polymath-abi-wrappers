...
export declare class SecurityTokenContract extends BaseContract {
    ...
    addModule: {
        sendTransactionAsync(_moduleFactory: string, _data: string, _maxCost: BigNumber, _budget: BigNumber, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    archiveModule: {
        sendTransactionAsync(_module: string, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    withdrawERC20: {
        sendTransactionAsync(_tokenContract: string, _value: BigNumber, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    changeModuleBudget: {
        sendTransactionAsync(_module: string, _change: BigNumber, _increase: boolean, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    updateTokenDetails: {
        sendTransactionAsync(_newTokenDetails: string, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    changeGranularity: {
        sendTransactionAsync(_granularity: BigNumber, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    transferWithData: {
        sendTransactionAsync(_to: string, _value: BigNumber, _data: string, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    transferFromWithData: {
        sendTransactionAsync(_from: string, _to: string, _value: BigNumber, _data: string, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    mint: {
        sendTransactionAsync(_investor: string, _value: BigNumber, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    mintWithData: {
        sendTransactionAsync(_investor: string, _value: BigNumber, _data: string, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    mintMulti: {
        sendTransactionAsync(_investors: string[], _values: BigNumber[], txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    burnWithData: {
        sendTransactionAsync(_value: BigNumber, _data: string, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    burnFromWithData: {
        sendTransactionAsync(_from: string, _value: BigNumber, _data: string, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    setController: {
        sendTransactionAsync(_controller: string, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    forceTransfer: {
        sendTransactionAsync(_from: string, _to: string, _value: BigNumber, _data: string, _log: string, txData?: Partial<TxData>): Promise<PolyResponse>;
    ...
    forceBurn: {
        sendTransactionAsync(_from: string, _value: BigNumber, _data: string, _log: string, txData?: Partial<TxData>): Promise<PolyResponse>;
