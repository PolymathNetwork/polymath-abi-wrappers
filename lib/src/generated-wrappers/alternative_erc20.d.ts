...
export declare type AlternativeERC20EventArgs = AlternativeERC20ApprovalEventArgs | AlternativeERC20TransferEventArgs;
export declare enum AlternativeERC20Events {
    Approval = "Approval",
    Transfer = "Transfer"
}
...
export declare class AlternativeERC20Contract extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>, _name: string, _symbol: string, _decimals: number | BigNumber): Promise<AlternativeERC20Contract>;
    constructor(abi: ContractAbi, address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, defaultEstimateGasFactor?: number);
}
//# sourceMappingURL=alternative_erc20.d.ts.map