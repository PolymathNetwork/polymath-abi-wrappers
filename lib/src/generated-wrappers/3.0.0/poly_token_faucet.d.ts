...
export declare type PolyTokenFaucetEventArgs_3_0_0 = PolyTokenFaucetTransferEventArgs_3_0_0 | PolyTokenFaucetApprovalEventArgs_3_0_0;
export declare enum PolyTokenFaucetEvents_3_0_0 {
    Transfer = "Transfer",
    Approval = "Approval"
}
...
export declare class PolyTokenFaucetContract_3_0_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<PolyTokenFaucetContract_3_0_0>;
    /**
