...
export declare type STOEventArgs_3_0_0 = STOPauseEventArgs_3_0_0 | STOUnpauseEventArgs_3_0_0 | STOSetFundRaiseTypesEventArgs_3_0_0;
export declare enum STOEvents_3_0_0 {
    Pause = "Pause",
    Unpause = "Unpause",
...
export declare class STOContract_3_0_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<STOContract_3_0_0>;
    /**
