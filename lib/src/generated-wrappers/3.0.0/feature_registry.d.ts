...
export declare type FeatureRegistryEventArgs_3_0_0 = FeatureRegistryOwnershipTransferredEventArgs_3_0_0 | FeatureRegistryChangeFeatureStatusEventArgs_3_0_0;
export declare enum FeatureRegistryEvents_3_0_0 {
...
export declare class FeatureRegistryContract_3_0_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>): Promise<FeatureRegistryContract_3_0_0>;
    /**
