...
export declare type PolyTokenEventArgs_3_0_0 = PolyTokenTransferEventArgs_3_0_0 | PolyTokenApprovalEventArgs_3_0_0;
export declare enum PolyTokenEvents_3_0_0 {
    Transfer = "Transfer",
    Approval = "Approval"
}
...
export declare class PolyTokenContract_3_0_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>, _polyDistributionContractAddress: string): Promise<PolyTokenContract_3_0_0>;
    /**
