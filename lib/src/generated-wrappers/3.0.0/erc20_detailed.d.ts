...
export declare type ERC20DetailedEventArgs_3_0_0 = ERC20DetailedTransferEventArgs_3_0_0 | ERC20DetailedApprovalEventArgs_3_0_0;
export declare enum ERC20DetailedEvents_3_0_0 {
    Transfer = "Transfer",
    Approval = "Approval"
}
...
export declare class ERC20DetailedContract_3_0_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>, name: string, symbol: string, decimals: number | BigNumber): Promise<ERC20DetailedContract_3_0_0>;
    /**
