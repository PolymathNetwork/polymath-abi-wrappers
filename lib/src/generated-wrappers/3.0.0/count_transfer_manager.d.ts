...
export declare type CountTransferManagerEventArgs_3_0_0 = CountTransferManagerModifyHolderCountEventArgs_3_0_0 | CountTransferManagerPauseEventArgs_3_0_0 | CountTransferManagerUnpauseEventArgs_3_0_0;
export declare enum CountTransferManagerEvents_3_0_0 {
...
export declare class CountTransferManagerContract_3_0_0 extends BaseContract {
    ...
    static deployAsync(bytecode: string, abi: ContractAbi, supportedProvider: SupportedProvider, txDefaults: Partial<TxData>, _securityToken: string, _polyToken: string): Promise<CountTransferManagerContract_3_0_0>;
    /**
