...
var GeneralTransferManagerContract = /** @class */ (function (_super) {
    ...
    function GeneralTransferManagerContract(abi, address, provider, txDefaults, defaultEstimateGasFactor) {
        ...
        _this.changeDefaults = {
            sendTransactionAsync: function (_defaultCanSendAfter, _defaultCanReceiveAfter, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_defaultCanSendAfter,
                                    _defaultCanReceiveAfter
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 2), _defaultCanSendAfter = _a[0], _defaultCanReceiveAfter = _a[1];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [_defaultCanSendAfter,
                                    _defaultCanReceiveAfter
                                ]);
                                encodedData = self._lookupEthersInterface('changeDefaults(uint64,uint64)').functions.changeDefaults.encode([_defaultCanSendAfter,
                                    _defaultCanReceiveAfter
                                ]);
                                return [4 /*yield*/, self._web3Wrapper.getAvailableAddressesAsync()];
                            case 1:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), contractDefaults, self.changeDefaults.estimateGasAsync.bind(self, _defaultCanSendAfter, _defaultCanReceiveAfter, estimateGasFactor))];
                            case 2:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 3:
            ...
            estimateGasAsync: function (_defaultCanSendAfter, _defaultCanReceiveAfter, factor, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, gas, networkGasLimit, _factor, _safetyGasEstimation;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_defaultCanSendAfter,
                                    _defaultCanReceiveAfter
                                ], base_contract_1.BaseContract._bigNumberToString), 2), _defaultCanSendAfter = _a[0], _defaultCanReceiveAfter = _a[1];
                                encodedData = self._lookupEthersInterface('changeDefaults(uint64,uint64)').functions.changeDefaults.encode([_defaultCanSendAfter,
                                    _defaultCanReceiveAfter
                                ]);
                                return [4 /*yield*/, self._web3Wrapper.getAvailableAddressesAsync()];
            ...
            getABIEncodedTransactionData: function (_defaultCanSendAfter, _defaultCanReceiveAfter) {
                var _a;
                var self = this;
                ...
                var abiEncodedTransactionData = self._lookupEthersInterface('changeDefaults(uint64,uint64)').functions.changeDefaults.encode([_defaultCanSendAfter,
                    _defaultCanReceiveAfter
                ]);
                return abiEncodedTransactionData;
            },
            callAsync: function (_defaultCanSendAfter, _defaultCanReceiveAfter, callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, functionSignature, inputAbi, ethersFunction, encodedData, callDataWithDefaults, rawCallResult, resultArray, outputAbi;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                encodedData = ethersFunction.encode([_defaultCanSendAfter,
                                    _defaultCanReceiveAfter
                                ]);
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, callData, { data: encodedData }), self._web3Wrapper.getContractDefaults())];
                            case 1:
        ...
        _this.changeIssuanceAddress = {
            sendTransactionAsync: function (_issuanceAddress, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), contractDefaults, self.changeIssuanceAddress.estimateGasAsync.bind(self, _issuanceAddress, estimateGasFactor))];
                            case 2:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 3:
        ...
        _this.changeSigningAddress = {
            sendTransactionAsync: function (_signingAddress, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), contractDefaults, self.changeSigningAddress.estimateGasAsync.bind(self, _signingAddress, estimateGasFactor))];
                            case 2:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 3:
        ...
        _this.changeAllowAllTransfers = {
            sendTransactionAsync: function (_allowAllTransfers, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), contractDefaults, self.changeAllowAllTransfers.estimateGasAsync.bind(self, _allowAllTransfers, estimateGasFactor))];
                            case 2:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 3:
        ...
        _this.changeAllowAllWhitelistTransfers = {
            sendTransactionAsync: function (_allowAllWhitelistTransfers, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), contractDefaults, self.changeAllowAllWhitelistTransfers.estimateGasAsync.bind(self, _allowAllWhitelistTransfers, estimateGasFactor))];
                            case 2:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 3:
        ...
        _this.changeAllowAllWhitelistIssuances = {
            sendTransactionAsync: function (_allowAllWhitelistIssuances, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), contractDefaults, self.changeAllowAllWhitelistIssuances.estimateGasAsync.bind(self, _allowAllWhitelistIssuances, estimateGasFactor))];
                            case 2:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 3:
        ...
        _this.changeAllowAllBurnTransfers = {
            sendTransactionAsync: function (_allowAllBurnTransfers, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), contractDefaults, self.changeAllowAllBurnTransfers.estimateGasAsync.bind(self, _allowAllBurnTransfers, estimateGasFactor))];
                            case 2:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 3:
        ...
        _this.verifyTransfer = {
            sendTransactionAsync: function (_from, _to, index_2, index_3, index_4, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), contractDefaults, self.verifyTransfer.estimateGasAsync.bind(self, _from, _to, index_2, index_3, index_4, estimateGasFactor))];
                            case 2:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 3:
        ...
        _this.modifyWhitelist = {
            sendTransactionAsync: function (_investor, _canSendAfter, _canReceiveAfter, _expiryTime, _canBuyFromSTO, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_investor,
                                    ...
                                    _expiryTime,
                                    _canBuyFromSTO
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 5), _investor = _a[0], _canSendAfter = _a[1], _canReceiveAfter = _a[2], _expiryTime = _a[3], _canBuyFromSTO = _a[4];
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), contractDefaults, self.modifyWhitelist.estimateGasAsync.bind(self, _investor, _canSendAfter, _canReceiveAfter, _expiryTime, _canBuyFromSTO, estimateGasFactor))];
                            case 2:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 3:
            ...
            estimateGasAsync: function (_investor, _canSendAfter, _canReceiveAfter, _expiryTime, _canBuyFromSTO, factor, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, gas, networkGasLimit, _factor, _safetyGasEstimation;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_investor,
                                    ...
                                    _expiryTime,
                                    _canBuyFromSTO
                                ], base_contract_1.BaseContract._bigNumberToString), 5), _investor = _a[0], _canSendAfter = _a[1], _canReceiveAfter = _a[2], _expiryTime = _a[3], _canBuyFromSTO = _a[4];
                                encodedData = self._lookupEthersInterface('modifyWhitelist(address,uint256,uint256,uint256,bool)').functions.modifyWhitelist.encode([_investor,
                                    _canSendAfter,
                                    _canReceiveAfter,
                                    _expiryTime,
            ...
            getABIEncodedTransactionData: function (_investor, _canSendAfter, _canReceiveAfter, _expiryTime, _canBuyFromSTO) {
                var _a;
                var self = this;
            ...
            callAsync: function (_investor, _canSendAfter, _canReceiveAfter, _expiryTime, _canBuyFromSTO, callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, functionSignature, inputAbi, ethersFunction, encodedData, callDataWithDefaults, rawCallResult, resultArray, outputAbi;
                    return __generator(this, function (_b) {
        ...
        _this.modifyWhitelistMulti = {
            sendTransactionAsync: function (_investors, _canSendAfters, _canReceiveAfters, _expiryTimes, _canBuyFromSTO, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_investors,
                                    ...
                                    _expiryTimes,
                                    _canBuyFromSTO
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 5), _investors = _a[0], _canSendAfters = _a[1], _canReceiveAfters = _a[2], _expiryTimes = _a[3], _canBuyFromSTO = _a[4];
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), contractDefaults, self.modifyWhitelistMulti.estimateGasAsync.bind(self, _investors, _canSendAfters, _canReceiveAfters, _expiryTimes, _canBuyFromSTO, estimateGasFactor))];
                            case 2:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 3:
            ...
            estimateGasAsync: function (_investors, _canSendAfters, _canReceiveAfters, _expiryTimes, _canBuyFromSTO, factor, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, gas, networkGasLimit, _factor, _safetyGasEstimation;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_investors,
                                    ...
                                    _expiryTimes,
                                    _canBuyFromSTO
                                ], base_contract_1.BaseContract._bigNumberToString), 5), _investors = _a[0], _canSendAfters = _a[1], _canReceiveAfters = _a[2], _expiryTimes = _a[3], _canBuyFromSTO = _a[4];
                                encodedData = self._lookupEthersInterface('modifyWhitelistMulti(address[],uint256[],uint256[],uint256[],bool[])').functions.modifyWhitelistMulti.encode([_investors,
                                    _canSendAfters,
                                    _canReceiveAfters,
                                    _expiryTimes,
            ...
            getABIEncodedTransactionData: function (_investors, _canSendAfters, _canReceiveAfters, _expiryTimes, _canBuyFromSTO) {
                var _a;
                var self = this;
            ...
            callAsync: function (_investors, _canSendAfters, _canReceiveAfters, _expiryTimes, _canBuyFromSTO, callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, functionSignature, inputAbi, ethersFunction, encodedData, callDataWithDefaults, rawCallResult, resultArray, outputAbi;
                    return __generator(this, function (_b) {
        ...
        _this.modifyWhitelistSigned = {
            sendTransactionAsync: function (_investor, _canSendAfter, _canReceiveAfter, _expiryTime, _canBuyFromSTO, _validFrom, _validTo, _nonce, _v, _r, _s, txData, estimateGasFactor) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, txHash, receipt;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_investor,
                                    ...
                                    _r,
                                    _s
                                ], base_contract_1.BaseContract._bigNumberToString.bind(self)), 11), _investor = _a[0], _canSendAfter = _a[1], _canReceiveAfter = _a[2], _expiryTime = _a[3], _canBuyFromSTO = _a[4], _validFrom = _a[5], _validTo = _a[6], _nonce = _a[7], _v = _a[8], _r = _a[9], _s = _a[10];
                                base_contract_1.BaseContract.strictArgumentEncodingCheck(inputAbi, [_investor,
                                    _canSendAfter,
                                    _canReceiveAfter,
                                    _expiryTime,
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, base_contract_1.BaseContract._applyDefaultsToTxDataAsync(__assign({ to: self.address }, txData, { data: encodedData }), contractDefaults, self.modifyWhitelistSigned.estimateGasAsync.bind(self, _investor, _canSendAfter, _canReceiveAfter, _expiryTime, _canBuyFromSTO, _validFrom, _validTo, _nonce, _v, _r, _s, estimateGasFactor))];
                            case 2:
                                txDataWithDefaults = _b.sent();
                                return [4 /*yield*/, self._web3Wrapper.sendTransactionAsync(txDataWithDefaults)];
                            case 3:
            ...
            estimateGasAsync: function (_investor, _canSendAfter, _canReceiveAfter, _expiryTime, _canBuyFromSTO, _validFrom, _validTo, _nonce, _v, _r, _s, factor, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, inputAbi, encodedData, defaultFromAddress, contractDefaults, txDataWithDefaults, gas, networkGasLimit, _factor, _safetyGasEstimation;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                _a = __read(base_contract_1.BaseContract._formatABIDataItemList(inputAbi, [_investor,
                                    ...
                                    _r,
                                    _s
                                ], base_contract_1.BaseContract._bigNumberToString), 11), _investor = _a[0], _canSendAfter = _a[1], _canReceiveAfter = _a[2], _expiryTime = _a[3], _canBuyFromSTO = _a[4], _validFrom = _a[5], _validTo = _a[6], _nonce = _a[7], _v = _a[8], _r = _a[9], _s = _a[10];
                                encodedData = self._lookupEthersInterface('modifyWhitelistSigned(address,uint256,uint256,uint256,bool,uint256,uint256,uint256,uint8,bytes32,bytes32)').functions.modifyWhitelistSigned.encode([_investor,
                                    _canSendAfter,
                                    _canReceiveAfter,
                                    _expiryTime,
            ...
            getABIEncodedTransactionData: function (_investor, _canSendAfter, _canReceiveAfter, _expiryTime, _canBuyFromSTO, _validFrom, _validTo, _nonce, _v, _r, _s) {
                var _a;
                var self = this;
            ...
            callAsync: function (_investor, _canSendAfter, _canReceiveAfter, _expiryTime, _canBuyFromSTO, _validFrom, _validTo, _nonce, _v, _r, _s, callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var _a, self, functionSignature, inputAbi, ethersFunction, encodedData, callDataWithDefaults, rawCallResult, resultArray, outputAbi;
                    return __generator(this, function (_b) {
