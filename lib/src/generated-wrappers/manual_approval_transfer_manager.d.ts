...
export declare class ManualApprovalTransferManagerContract extends BaseContract {
    ...
    verifyTransfer: {
        sendTransactionAsync(_from: string, _to: string, _amount: BigNumber, index_3: string, _isTransfer: boolean, txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
        estimateGasAsync(_from: string, _to: string, _amount: BigNumber, index_3: string, _isTransfer: boolean, txData?: Partial<TxData>): Promise<number>;
    ...
    addManualApproval: {
        sendTransactionAsync(_from: string, _to: string, _allowance: BigNumber, _expiryTime: BigNumber, _description: string, txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
        estimateGasAsync(_from: string, _to: string, _allowance: BigNumber, _expiryTime: BigNumber, _description: string, txData?: Partial<TxData>): Promise<number>;
    ...
    addManualApprovalMulti: {
        sendTransactionAsync(_from: string[], _to: string[], _allowances: BigNumber[], _expiryTimes: BigNumber[], _descriptions: string[], txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
        estimateGasAsync(_from: string[], _to: string[], _allowances: BigNumber[], _expiryTimes: BigNumber[], _descriptions: string[], txData?: Partial<TxData>): Promise<number>;
    ...
    modifyManualApproval: {
        sendTransactionAsync(_from: string, _to: string, _expiryTime: BigNumber, _changedAllowance: BigNumber, _description: string, _change: number | BigNumber, txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
        estimateGasAsync(_from: string, _to: string, _expiryTime: BigNumber, _changedAllowance: BigNumber, _description: string, _change: number | BigNumber, txData?: Partial<TxData>): Promise<number>;
    ...
    modifyManualApprovalMulti: {
        sendTransactionAsync(_from: string[], _to: string[], _expiryTimes: BigNumber[], _changedAllowances: BigNumber[], _descriptions: string[], _changes: (number | BigNumber)[], txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
        estimateGasAsync(_from: string[], _to: string[], _expiryTimes: BigNumber[], _changedAllowances: BigNumber[], _descriptions: string[], _changes: (number | BigNumber)[], txData?: Partial<TxData>): Promise<number>;
    ...
    revokeManualApproval: {
        sendTransactionAsync(_from: string, _to: string, txData?: Partial<TxData>): Promise<TransactionReceiptWithDecodedLogs>;
        estimateGasAsync(_from: string, _to: string, txData?: Partial<TxData>): Promise<number>;
